...
class Companion {
  constructor() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = element.j3f_1;
      destination.g4(tmp$ret$2, element);
    }
    tmp.k3f_1 = destination;
    this.l3f_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  m3f(code) {
    return this.k3f_1.d4(code);
  }
}
...
class CloseReason {
  constructor(code, message) {
    return new.target.p3f(code, message);
  }
  static p3f(code, message) {
    var $this = createThis(this);
    $this.n3f_1 = code;
    $this.o3f_1 = message;
    return $this;
  }
  static q3f(code, message) {
    return this.p3f(code.j3f_1, message);
  }
  r3f() {
    return Companion_getInstance().m3f(this.n3f_1);
  }
  toString() {
    var tmp0_elvis_lhs = this.r3f();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.n3f_1 : tmp0_elvis_lhs) + ', message=' + this.o3f_1 + ')';
  }
  hashCode() {
    var result = this.n3f_1;
    result = imul(result, 31) + getStringHashCode(this.o3f_1) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
    ...
    if (!(other instanceof CloseReason))
      return false;
    if (!(this.n3f_1 === other.n3f_1))
      return false;
    if (!(this.o3f_1 === other.o3f_1))
      return false;
    return true;
  }
}
...
function *send(frame, $completion) {
  yield* this.w3f().g1b(frame, $completion);
...
class Companion_0 {
  constructor() {
    ...
    this.w3g_1 = Pong.s3h(new Int8Array(0), NonDisposableHandle_instance);
  }
}
class DefaultWebSocketSessionImpl {
  constructor(raw, pingIntervalMillis, timeoutMillis, incomingFramesConfig, outgoingFramesConfig) {
    ...
    this.e3g_1 = Job();
    this.f3g_1 = this.b3g_1.fw().om(Key_instance).qm(this.e3g_1).qm(new CoroutineName('ws-default'));
  ...
  t3f(value) {
    this.b3g_1.t3f(value);
  }
  u3f() {
    return this.b3g_1.u3f();
  }
  s3f(negotiatedExtensions) {
    ...
    if (get_isTraceEnabled(this_0)) {
      ...
      this_0.t2w(tmp$ret$2);
    }
    this.j3g_1.o2(negotiatedExtensions);
    runOrCancelPinger(this);
    var incomingJob = runIncomingProcessor(this, ponger(this, this.w3f()));
  ...
  *e2n($completion) {
    yield* this.b3g_1.e2n($completion);
    return Unit_instance;
  }
}
...
class FrameTooBigException extends Exception {
  constructor(frameSize, cause) {
    return new.target.h3h(frameSize, cause);
  }
  static h3h(frameSize, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.rd(cause);
    captureStack($this, $this.g3h_1);
    $this.f3h_1 = frameSize;
    delete $this.message;
    return $this;
  }
  r() {
    var sizeSuffix = this.f3h_1 >= 0n ? ': ' + this.f3h_1.toString() : '';
    return 'Frame is too big' + sizeSuffix;
  }
  f13() {
    return FrameTooBigException.h3h(this.f3h_1, this);
  }
  get message() {
    return this.r();
  }
...
class Companion_1 {
  constructor() {
    ...
    tmp.z3h_1 = ensureNotNull(tmp$ret$0).y3h_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.z3h_1 + 1 | 0;
...
class Companion_2 {
  constructor() {
    ...
    this_0.z3f_1 = this_0.j3i();
    this_0.a3g_1 = this_0.j3i();
    tmp.y3f_1 = this_0;
  }
}
class WebSocketChannelsConfig {
  constructor() {
    ...
    this.z3f_1 = Companion_getInstance_3().k3i_1;
    this.a3g_1 = Companion_getInstance_3().k3i_1;
  }
  j3i() {
    return Companion_getInstance_3().k3i_1;
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.k3i_1 = new ChannelConfig(2147483647, ChannelOverflow_SUSPEND_getInstance());
  }
}
class ChannelConfig {
  constructor(capacity, onOverflow) {
    ...
    this.l3i_1 = capacity;
    this.m3i_1 = onOverflow;
  }
  n3i() {
    return this.m3i_1.equals(ChannelOverflow_SUSPEND_getInstance()) && !(this.l3i_1 === 2147483647);
  }
}
...
class BoundedChannel {
  constructor(capacity, delegate) {
    delegate = delegate === VOID ? Companion_instance_4.s3i(capacity) : delegate;
    this.t3i_1 = delegate;
  }
  u3i(element) {
    var result = this.t3i_1.h1b(element);
    if (!_ChannelResult___get_isSuccess__impl__odq1z9(result) && !_ChannelResult___get_isClosed__impl__mg7kuu(result)) {
      this.q1b(ChannelOverflowException.r3i('Channel overflowed'));
    }
    return result;
  }
  h1b(element) {
    return this.u3i(element);
  }
  *v3i(element, $completion) {
    yield* this.t3i_1.g1b(element, $completion);
    return Unit_instance;
  }
  g1b(element, $completion) {
    return this.v3i(element, $completion);
  }
  q1b(cause) {
    return this.t3i_1.q1b(cause);
  }
  z1a() {
    return this.t3i_1.z1a();
  }
  *w3i($completion) {
    return yield* this.t3i_1.j1b($completion);
  }
  j1b($completion) {
    return this.w3i($completion);
  }
  l1() {
    return this.t3i_1.l1();
  }
  ox(cause) {
    this.t3i_1.ox(cause);
  }
...
class ChannelOverflowException extends RuntimeException {
  constructor(message) {
    return new.target.r3i(message);
  }
  static r3i(message) {
    var $this = this.ja(message);
    captureStack($this, $this.q3i_1);
    return $this;
  }
}
...
class WebSocketExtensionsConfig {
  constructor() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.z3i_1 = ArrayList.l2();
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp_0.a3j_1 = [false, false, false];
  }
  r30() {
...
class WebSocketExtensionHeader {
  constructor(name, parameters) {
    this.b3j_1 = name;
    this.c3j_1 = parameters;
  }
  toString() {
    return this.b3j_1 + ' ' + parametersToString(this);
  }
}
class Frame {
  static l3j(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
...
class Binary extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.k3j(fin, data, rsv1, rsv2, rsv3);
  }
  static k3j(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.l3j(fin, FrameType_BINARY_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static m3j(fin, data) {
    return this.k3j(fin, data, false, false, false);
  }
}
class Text extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.u3j(fin, data, rsv1, rsv2, rsv3);
  }
  static u3j(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.l3j(fin, FrameType_TEXT_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static v3j(fin, data) {
    return this.u3j(fin, data, false, false, false);
  }
  static w3j(text) {
    return this.v3j(true, toByteArray(text));
  }
}
class Close extends Frame {
  constructor(data) {
    return new.target.x3j(data);
  }
  static x3j(data) {
    return this.l3j(true, FrameType_CLOSE_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
  static v3g(reason) {
    // Inline function 'io.ktor.utils.io.core.buildPacket' call
    var builder = new Buffer();
    builder.v2j(reason.n3f_1);
    writeText(builder, reason.o3f_1);
    return this.y3j(builder);
  }
  static y3j(packet) {
    return this.x3j(readByteArray(packet));
  }
  static z3j() {
    return this.x3j(Companion_getInstance_5().t3h_1);
  }
}
class Ping extends Frame {
  constructor(data) {
    return new.target.i3i(data);
  }
  static i3i(data) {
    return this.l3j(true, FrameType_PING_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
}
class Pong extends Frame {
  constructor(data, disposableHandle) {
    return new.target.s3h(data, disposableHandle);
  }
  static s3h(data, disposableHandle) {
    disposableHandle = disposableHandle === VOID ? NonDisposableHandle_instance : disposableHandle;
    return this.l3j(true, FrameType_PONG_getInstance(), data, disposableHandle, false, false, false);
  }
}
class Companion_5 {
  constructor() {
    Companion_instance_5 = this;
    this.t3h_1 = new Int8Array(0);
  }
  u3h(fin, frameType, data, rsv1, rsv2, rsv3) {
    var tmp;
    switch (frameType.s1_1) {
      case 1:
        tmp = Binary.k3j(fin, data, rsv1, rsv2, rsv3);
        break;
      case 0:
        tmp = Text.u3j(fin, data, rsv1, rsv2, rsv3);
        break;
      case 2:
        tmp = Close.x3j(data);
        break;
      case 3:
        ...
        break;
      case 4:
        tmp = Pong.s3h(data, NonDisposableHandle_instance);
        break;
      default:
...
function DefaultWebSocketSession_0(session, pingIntervalMillis, timeoutMillis, channelsConfig) {
  ...
  channelsConfig = channelsConfig === VOID ? Companion_getInstance_2().y3f_1 : channelsConfig;
  _init_properties_DefaultWebSocketSession_kt__469s0y();
  ...
  return new DefaultWebSocketSessionImpl(session, pingIntervalMillis, timeoutMillis, channelsConfig.z3f_1, channelsConfig.a3g_1);
}
function runIncomingProcessor($this, ponger) {
  var tmp = get_IncomingProcessorCoroutineName().qm(Dispatchers_getInstance().e17_1);
...
function runOutgoingProcessor($this) {
  var tmp = get_OutgoingProcessorCoroutineName().qm(Dispatchers_getInstance().e17_1);
...
function *outgoingProcessorLoop($this, $completion) {
  var _iterator__ex2g4s = $this.h3g_1.l1();
  $l$loop: while (yield* _iterator__ex2g4s.s1a($completion)) {
    var frame = _iterator__ex2g4s.n1();
    // Inline function 'io.ktor.util.logging.trace' call
    var this_0 = get_LOGGER();
    if (get_isTraceEnabled(this_0)) {
      var tmp$ret$1 = 'Sending ' + frame.toString() + ' from session ' + toString($this);
      this_0.t2w(tmp$ret$1);
    }
    var tmp;
    ...
    yield* $this.b3g_1.w3f().g1b(processedFrame, $completion);
  }
  return Unit_instance;
}
function *sendCloseSequence($this, reason, exception, $completion) {
  ...
  $this.e3g_1.u12();
  var reasonToSend = reason == null ? CloseReason.q3f(Codes_NORMAL_getInstance(), '') : reason;
  try {
    runOrCancelPinger($this);
    if (!(reasonToSend.n3f_1 === Codes_CLOSED_ABNORMALLY_getInstance().j3f_1)) {
      yield* $this.b3g_1.w3f().g1b(Close.v3g(reasonToSend), $completion);
    }
  }finally {
    $this.d3g_1.s12(reasonToSend);
    if (!(exception == null)) {
      $this.h3g_1.q1b(exception);
      $this.g3g_1.q1b(exception);
    }
  }
  return Unit_instance;
}
...
function runOrCancelPinger($this) {
  ...
  if (tmp0_safe_receiver == null)
    ...
    tmp0_safe_receiver.s1b();
  var tmp2_safe_receiver = newPinger == null ? null : new ChannelResult(newPinger.h1b(Companion_getInstance_0().w3g_1));
  if (tmp2_safe_receiver == null)
    null;
  else
    _ChannelResult___get_isSuccess__impl__odq1z9(tmp2_safe_receiver.f1b_1);
  if ($this.i3g_1.kotlinx$atomicfu$value && !(newPinger == null)) {
    runOrCancelPinger($this);
  }
}
function *checkMaxFrameSize($this, packet, frame, $completion) {
  var tmp = frame.z3g_1.length;
  var tmp1_elvis_lhs = packet == null ? null : get_size(packet);
  var size = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
  if (fromInt(size) > $this.u3f()) {
    if (packet == null)
      null;
    else {
      packet.y5();
    }
    yield* close($this, CloseReason.q3f(Codes_TOO_BIG_getInstance(), 'Frame is too big: ' + size + '. Max size is ' + $this.u3f().toString()), $completion);
    throw FrameTooBigException.h3h(fromInt(size));
  }
  return Unit_instance;
}
function processIncomingExtensions($this, frame) {
  ...
  var _iterator__ex2g4s = $this.i3h().l1();
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.j3h(current);
  }
  return accumulator;
}
function processOutgoingExtensions($this, frame) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.k3h(current);
  }
  return accumulator;
}
...
function DefaultWebSocketSessionImpl$start$slambda($incomingJob, $outgoingJob, this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* $incomingJob.lx($completion);
    yield* $outgoingJob.lx($completion);
    this$0.e3g_1.px();
    return Unit_instance;
  }, 1);
}
  ...
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
          ...
          while (yield* _iterator__ex2g4s.s1a($completion)) {
            ...
            $l$block_0: {
              ...
              if (get_isTraceEnabled(this_0)) {
                ...
                this_0.t2w(tmp$ret$5);
              }
              if (e instanceof Close) {
                if (!this$0.w3f().z1a()) {
                  var tmp = this$0.w3f();
                  var tmp1_elvis_lhs = readReason(e);
                  yield* tmp.g1b(Close.v3g(tmp1_elvis_lhs == null ? get_NORMAL_CLOSE() : tmp1_elvis_lhs), $completion);
                }
                closeFramePresented = true;
                return Unit_instance;
              } else {
                if (e instanceof Pong) {
                  var tmp2_safe_receiver = this$0.c3g_1.kotlinx$atomicfu$value;
                  if (tmp2_safe_receiver == null)
                    null;
                  else
                    yield* tmp2_safe_receiver.g1b(e, $completion);
                } else {
                  if (e instanceof Ping)
                    yield* $ponger.g1b(e, $completion);
                  else {
                    ...
                    if (!e.x3g_1) {
                      ...
                      writeFully(frameBody, e.z3g_1);
                      break $l$block_0;
                    }
                    if (firstFrame == null) {
                      yield* this$0.g3g_1.g1b(processIncomingExtensions(this$0, e), $completion);
                      break $l$block_0;
                    }
                    writeFully(ensureNotNull(frameBody), e.z3g_1);
                    var defragmented = Companion_getInstance_5().u3h(true, firstFrame.y3g_1, readByteArray(build(frameBody)), firstFrame.b3h_1, firstFrame.c3h_1, firstFrame.d3h_1);
                    firstFrame = null;
                    yield* this$0.g3g_1.g1b(processIncomingExtensions(this$0, defragmented), $completion);
                  }
                }
              }
            }
      ...
      if (tmp0_safe_receiver == null)
        ...
        tmp0_safe_receiver.y5();
      }
      this$0.g3g_1.s1b();
      if (!closeFramePresented) {
        yield* close(this$0, CloseReason.q3f(Codes_CLOSED_ABNORMALLY_getInstance(), 'Connection was closed without close frame'), $completion);
      }
    }
    return Unit_instance;
  }, 1);
...
function DefaultWebSocketSessionImpl$runOutgoingProcessor$slambda(this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
      ...
      if ($p instanceof ClosedSendChannelException) {
        ...
        if ($p instanceof ClosedReceiveChannelException) {
          ...
          if ($p instanceof CancellationException) {
            ...
            tmp_0 = yield* /*#__NOINLINE__*/sendCloseSequence(this$0, CloseReason.q3f(Codes_NORMAL_getInstance(), ''), VOID, $completion);
          } else {
            if ($p instanceof ChannelIOException) {
              ...
              if ($p instanceof Error) {
                var cause = $p;
                this$0.h3g_1.ox(CancellationException.p('Failed to send frame', cause));
                yield* closeExceptionally(this$0.b3g_1, cause, $completion);
                return Unit_instance;
              } else {
                throw $p;
              }
      ...
      this$0.h3g_1.u1b();
      yield* close(this$0.b3g_1, VOID, $completion);
    }
    return Unit_instance;
  }, 1);
}
function DefaultWebSocketSessionImpl$runOrCancelPinger$slambda(this$0) {
  return constructCallableReference(function *(it, $completion) {
    yield* /*#__NOINLINE__*/sendCloseSequence(this$0, it, IOException.d2l('Ping timeout'), $completion);
    return Unit_instance;
  }, 1);
}
...
function _init_properties_DefaultWebSocketSession_kt__469s0y() {
  if (!properties_initialized_DefaultWebSocketSession_kt_6cjlhc) {
    ...
    NORMAL_CLOSE = CloseReason.q3f(Codes_NORMAL_getInstance(), 'OK');
...
function readReason(_this__u8e3s4) {
  if (_this__u8e3s4.z3g_1.length < 2) {
    return null;
  }
  // Inline function 'io.ktor.utils.io.core.buildPacket' call
  var builder = new Buffer();
  writeFully(builder, _this__u8e3s4.z3g_1);
  var packet = builder;
  var code = packet.n2i();
  var message = readText(packet);
  return CloseReason.p3f(code, message);
}
...
function pinger(_this__u8e3s4, outgoing, periodMillis, timeoutMillis, onTimeout) {
  ...
  var tmp_0 = ensureNotNull(_this__u8e3s4.fw().rc(Key_instance));
  tmp_0.hx(pinger$lambda(actorJob));
  return channel;
}
    ...
    try {
      ...
      $l$block: {
        ...
        try {
          ...
          while (yield* _iterator__ex2g4s.s1a($completion)) {
            var e = _iterator__ex2g4s.n1();
            get_LOGGER().t2w('Received ping message, sending pong message');
            yield* $outgoing.g1b(Pong.s3h(e.z3g_1), $completion);
          }
          break $l$block;
        } catch ($p) {
          if ($p instanceof Error) {
...
function pinger$slambda$slambda_0($outgoing, $pingMessage, $channel) {
  return constructCallableReference(function *($this$withTimeoutOrNull, $completion) {
    get_LOGGER().t2w('WebSocket Pinger: sending ping frame');
    yield* $outgoing.g1b(Ping.i3i(toByteArray($pingMessage, Charsets_getInstance().z2o_1)), $completion);
    $l$loop: while (true) {
      var msg = yield* $channel.j1b($completion);
      if (decodeToString(msg.z3g_1, 0, 0 + msg.z3g_1.length | 0) === $pingMessage) {
        get_LOGGER().t2w('WebSocket Pinger: received valid pong frame ' + msg.toString());
        break $l$loop;
      }
      get_LOGGER().t2w('WebSocket Pinger: received invalid pong frame ' + msg.toString() + ', continue waiting');
    }
    return Unit_instance;
  }, 1);
}
function pinger$slambda($periodMillis, $timeoutMillis, $onTimeout, $channel, $outgoing) {
  return constructCallableReference(function *($this$launch, $completion) {
    get_LOGGER().t2w('Starting WebSocket pinger coroutine with period ' + $periodMillis.toString() + ' ms and timeout ' + $timeoutMillis.toString() + ' ms');
    ...
    try {
      $l$loop: while (true) {
        ...
        if (rc == null) {
          get_LOGGER().t2w('WebSocket pinger has timed out');
          yield* $onTimeout(CloseReason.q3f(Codes_INTERNAL_ERROR_getInstance(), 'Ping timeout'), $completion);
          break $l$loop;
        }
      }
      tmp = Unit_instance;
...
function from(_this__u8e3s4, config) {
  ...
  var tmp;
  if (config.l3i_1 === 2147483647) {
    tmp = Channel(2147483647);
  } else if (config.m3i_1.equals(ChannelOverflow_SUSPEND_getInstance())) {
    tmp = Channel(config.l3i_1, BufferOverflow_SUSPEND_getInstance());
  } else if (config.m3i_1.equals(ChannelOverflow_CLOSE_getInstance())) {
    tmp = new BoundedChannel(config.l3i_1);
  } else {
    // Inline function 'kotlin.error' call
...
function BoundedChannel$Companion$createDelegate$lambda($channel) {
  return (it) => {
    ...
    if (!tmp_0.z1a()) {
      ...
      tmp_1.q1b(ChannelOverflowException.r3i('Channel overflowed'));
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function parametersToString($this) {
  return $this.c3j_1.j1() ? '' : '; ' + joinToString($this.c3j_1, ';');
}
...
function *close(_this__u8e3s4, reason, $completion) {
  reason = reason === VOID ? CloseReason.q3f(Codes_NORMAL_getInstance(), '') : reason;
  try {
    yield* _this__u8e3s4.x3f(Close.v3g(reason), $completion);
...
function *closeExceptionally(_this__u8e3s4, cause, $completion) {
  ...
  if (cause instanceof CancellationException) {
    tmp = CloseReason.q3f(Codes_NORMAL_getInstance(), '');
  } else {
    tmp = CloseReason.q3f(Codes_INTERNAL_ERROR_getInstance(), cause.toString());
  }
  var reason = tmp;
...
protoOf(DefaultWebSocketSessionImpl).x3f = send;
...
protoOf(BoundedChannel).s1b = close$default;
protoOf(BoundedChannel).u1b = cancel$default;
...
initMetadataForClass(Close, 'Close', Close.z3j);
