...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.y3c_1 = coroutineContext;
    this.z3c_1 = null;
    this.a3d_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  fw() {
    return this.y3c_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.c3d_1 = 0;
    this.d3d_1 = 0;
    this.e3d_1 = get_HeadersDataPool().n2p();
  }
  o24(name) {
    if (this.c3d_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.d3d_1 | 0;
    while (!(this.e3d_1.j3d(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.l3d(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.d3d_1 | 0;
    }
    return null;
  }
  m3d() {
    return this.e3d_1.i3d();
  }
  k3d(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.b3d_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.b3d_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.d3d_1 | 0;
    ...
    this.e3d_1.u3d(headerOffset + 0 | 0, hash);
    this.e3d_1.u3d(headerOffset + 1 | 0, nameStartIndex);
    this.e3d_1.u3d(headerOffset + 2 | 0, nameEndIndex);
    this.e3d_1.u3d(headerOffset + 3 | 0, valueStartIndex);
    this.e3d_1.u3d(headerOffset + 4 | 0, valueEndIndex);
    this.e3d_1.u3d(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.e3d_1.u3d(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.c3d_1 = this.c3d_1 + 1 | 0;
  }
  v3d(headerOffset) {
    var nameStartIndex = this.e3d_1.j3d(headerOffset + 1 | 0);
    var nameEndIndex = this.e3d_1.j3d(headerOffset + 2 | 0);
    return this.b3d_1.c(nameStartIndex, nameEndIndex);
  }
  l3d(headerOffset) {
    var valueStartIndex = this.e3d_1.j3d(headerOffset + 3 | 0);
    var valueEndIndex = this.e3d_1.j3d(headerOffset + 4 | 0);
    return this.b3d_1.c(valueStartIndex, valueEndIndex);
  }
  t1e() {
    this.c3d_1 = 0;
    this.d3d_1 = 0;
    get_HeadersDataPool().o2p(this.e3d_1);
    this.e3d_1 = get_HeadersDataPool().n2p();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.f3d_1 = ArrayList.l2();
  }
  g3d() {
    return this.f3d_1.m2();
  }
  h3d(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.f3d_1.d2(get_IntArrayPool().n2p());
      }
       while (inductionVariable < subArraysCount);
  }
  j3d(index) {
    return this.f3d_1.k2(index / 768 | 0)[index % 768 | 0];
  }
  u3d(index, value) {
    this.f3d_1.k2(index / 768 | 0)[index % 768 | 0] = value;
  }
  i3d() {
    return sequence(HeadersData$headersStarts$slambda(this));
  }
  t1e() {
    var _iterator__ex2g4s = this.f3d_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().o2p(array);
    }
    this.f3d_1.x3();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  z3d(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).l2p.call(this, instance);
  }
  l2p(instance) {
    return this.z3d(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  l2p(instance) {
    return this.d3e(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  constructor(message) {
    return new.target.k3e(message);
  }
  static k3e(message) {
    var $this = this.o(message);
    captureStack($this, $this.j3e_1);
    return $this;
  }
}
...
class Companion {
  l3e(from) {
    ...
    return this.y3e(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  y3e(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
    ...
    if (tmp1_elvis_lhs == null) {
      throw NoSuchElementException.a2('Unable to build char tree from an empty list');
    } else {
    ...
    if (tmp$ret$2)
      throw IllegalArgumentException.w1('There should be no empty entries');
    var root = ArrayList.l2();
...
class SubSequenceImpl {
  ...
  a() {
    return this.b3f_1 - this.a3f_1 | 0;
  }
  b(index) {
    var withOffset = index + this.a3f_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.b3f_1 - this.a3f_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.w1(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.d3f_1, this.a3f_1 + startIndex | 0, this.a3f_1 + endIndex | 0);
  }
  toString() {
    var tmp0_elvis_lhs = this.c3f_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.d3f_1, this.a3f_1, this.b3f_1));
      this.c3f_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.d3f_1, this.a3f_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.c3f_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.d3f_1, this.a3f_1, this.b3f_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.t3d_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.t3d_1 + ')';
      throw IllegalArgumentException.w1(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.t3d_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.t3d_1 + ')';
      throw IllegalArgumentException.w1(toString(message_1));
    }
  ...
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.t3d_1));
      this.q3d_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.t3d_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.t3d_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.q3d_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.t3d_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.p3d_1).length - this.s3d_1 | 0] = value;
    this.q3d_1 = null;
    this.s3d_1 = this.s3d_1 - 1 | 0;
    this.t3d_1 = this.t3d_1 + 1 | 0;
    return this;
  }
  hg(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.s3d_1 | 0;
      ...
      this.s3d_1 = this.s3d_1 - bytesToCopy | 0;
    }
    this.q3d_1 = null;
    this.t3d_1 = this.t3d_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  i2(value) {
    if (value == null)
      return this;
    return this.hg(value, 0, charSequenceLength(value));
  }
  t1e() {
    var list = this.o3d_1;
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.n3d_1.o2p(list.k2(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.p3d_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.n3d_1.o2p(tmp0_safe_receiver);
      }
      this.p3d_1 = null;
    }
    this.r3d_1 = true;
...
class UnsupportedMediaTypeExceptionCIO extends IOException {
  constructor(message) {
    return new.target.t3e(message);
  }
  static t3e(message) {
    var $this = this.d2l(message);
    captureStack($this, $this.s3e_1);
    return $this;
  }
}
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.e3e_1 + ', end=' + this.f3e_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.c3d_1 >= $this.d3d_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.c3d_1;
  var prevData = $this.e3d_1;
  $this.c3d_1 = 0;
  $this.d3d_1 = imul($this.d3d_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().n2p();
  this_0.h3d(imul(prevData.g3d(), 2) | 1);
  tmp.e3d_1 = this_0;
  var _iterator__ex2g4s = prevData.i3d().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.k3d(prevData.j3d(headerOffset + 1 | 0), prevData.j3d(headerOffset + 2 | 0), prevData.j3d(headerOffset + 3 | 0), prevData.j3d(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().o2p(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.c3d_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.e3d_1.j3d(headerOffset + 1 | 0);
  var nameEndIndex = $this.e3d_1.j3d(headerOffset + 2 | 0);
  return equalsLowerCase($this.b3d_1, nameStartIndex, nameEndIndex, name);
}
function HeadersData$headersStarts$slambda(this$0) {
  return constructCallableReference(function *($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this$0.f3d_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this$0.j3d(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.xk(joinedIndex, $completion);
        }
...
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.m3d().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.i2(indent);
    out.i2(_this__u8e3s4.v3d(offset));
    out.i2(' => ');
    out.i2(_this__u8e3s4.l3d(offset));
    out.i2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.f3e_1 = builder.t3d_1;
      var rangeLength = range.f3e_1 - range.e3e_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.e3e_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.f3e_1;
      parseHeaderValue(builder, range);
      var valueStart = range.e3e_1;
      var valueEnd = range.f3e_1;
      range.e3e_1 = headerEnd;
      headers.k3d(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.o24('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.e3e_1;
  var end = range.f3e_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.e3e_1)) {
      range.e3e_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.e3e_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.e3e_1 = valueStart;
  range.f3e_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.k3e("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
    ...
    while (inductionVariable < charSequenceLength(host)) {
      ...
      inductionVariable = inductionVariable + 1 | 0;
      if (get_hostForbiddenSymbols().r3(new Char(element))) {
        tmp$ret$0 = true;
        break $l$block;
      }
    }
  ...
  if (tmp$ret$0) {
    throw ParserException.k3e('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.k3e('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.k3e('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.e3e_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.f3e_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.k3e('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.k3e('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().o2o_1, Companion_getInstance_0().n2o_1);
    versions = Companion_instance.l3e(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().u2z(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.t3e('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.n2h(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.d2l("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.d2l('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.d2l('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.y2h('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.o24('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.d2l('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.d2l("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda($firstBoundary, $countedInput) {
  return constructCallableReference(function *($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl($firstBoundary, $countedInput, $this$writer.d2o_1, 8193n, $completion);
    yield* $this$writer.d2o_1.g2n($completion);
    return Unit_instance;
  }, 1);
}
function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  return constructCallableReference(function *($this$produce, $completion) {
    ...
    var readBeforeParse = countedInput.l2o();
    var firstBoundary = $boundaryPrefixed.o2h(get_PrefixString().m2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda(firstBoundary, countedInput)).t2n_1, $completion);
    var tmp;
    if (get_remaining(preambleData) > 0n) {
      tmp = yield* $this$produce.g1b(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.w2m() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
      ...
      try {
        ...
        if ($p instanceof Error) {
          var cause = $p;
          if (headers.t12(cause)) {
            var tmp0_safe_receiver = headersMap;
            if (tmp0_safe_receiver == null)
              null;
            else {
              tmp0_safe_receiver.t1e();
            }
          }
          close(body, cause);
          throw cause;
    ...
    var tmp_0;
    if (!($totalLength == null)) {
      var consumedExceptEpilogue = subtract(countedInput.l2o(), readBeforeParse);
      var size = subtract($totalLength, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.d2l('Failed to parse multipart: prologue is too long');
      var tmp_1;
      if (size > 0n) {
        tmp_1 = yield* $this$produce.g1b(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
      tmp_0 = tmp_1;
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      var tmp_2;
      if (!epilogueContent.a2i()) {
        tmp_2 = yield* $this$produce.g1b(new Epilogue(epilogueContent), $completion);
      }
      tmp_0 = tmp_2;
    }
    return Unit_instance;
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.n2h(toByteArray_0('\r\n'));
...
function build($this, resultList, from, maxLength, idx, length, charAt) {
  ...
  while (_iterator__ex2g4s_0.m1()) {
    ...
    var ch = element_0.v2().e3_1;
    // Inline function 'kotlin.collections.component2' call
    var list_0 = element_0.w2();
    var nextIdx = idx + 1 | 0;
    var children = ArrayList.l2();
    ...
    resultList.d2(new Node(ch, destination_1, children));
  }
}
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.p3d_1).length | 0];
}
function copy($this, startIndex, endIndex) {
  if (startIndex === endIndex)
    return '';
  var builder = StringBuilder.lb(endIndex - startIndex | 0);
  var buffer;
...
function bufferForIndex($this, index) {
  ...
  return list.k2(index / ensureNotNull($this.p3d_1).length | 0);
}
function throwSingleBuffer($this, index) {
  if ($this.r3d_1)
    throw IllegalStateException.o('Buffer is already released');
  throw IndexOutOfBoundsException.wd('' + index + ' is not in range [0; ' + currentPosition($this) + ')');
}
function nonFullBuffer($this) {
  return $this.s3d_1 === 0 ? appendNewArray($this) : ensureNotNull($this.p3d_1);
}
function appendNewArray($this) {
  var newBuffer = $this.n3d_1.n2p();
  var existing = $this.p3d_1;
  $this.p3d_1 = newBuffer;
  $this.s3d_1 = newBuffer.length;
  $this.r3d_1 = false;
  if (!(existing == null)) {
    var tmp0_elvis_lhs = $this.o3d_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
...
function currentPosition($this) {
  return ensureNotNull($this.p3d_1).length - $this.s3d_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.ge('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.ge('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.z35_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.z35_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().y35_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.y3e(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
    // Inline function 'kotlin.collections.map' call
    var this_0 = numberRangeToNumber(0, 255);
    // Inline function 'kotlin.collections.mapTo' call
    var destination = ArrayList.h2(collectionSizeOrDefault(this_0, 10));
    var inductionVariable = this_0.y2_1;
    var last = this_0.z2_1;
    if (inductionVariable <= last)
      do {
    ...
    // Inline function 'kotlin.collections.mapTo' call
    var destination_0 = ArrayList.h2(collectionSizeOrDefault(this_9, 10));
    var inductionVariable_0 = this_9.y2_1;
    var last_0 = this_9.z2_1;
