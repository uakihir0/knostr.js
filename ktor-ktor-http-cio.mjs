...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.u3b_1 = coroutineContext;
    this.v3b_1 = null;
    this.w3b_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  q1s() {
    return this.u3b_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.y3b_1 = 0;
    this.z3b_1 = 0;
    this.a3c_1 = get_HeadersDataPool().j2o();
  }
  q1i(name) {
    if (this.y3b_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.z3b_1 | 0;
    while (!(this.a3c_1.f3c(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.h3c(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.z3b_1 | 0;
    }
    return null;
  }
  i3c() {
    return this.a3c_1.e3c();
  }
  g3c(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.x3b_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.x3b_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.z3b_1 | 0;
    ...
    this.a3c_1.q3c(headerOffset + 0 | 0, hash);
    this.a3c_1.q3c(headerOffset + 1 | 0, nameStartIndex);
    this.a3c_1.q3c(headerOffset + 2 | 0, nameEndIndex);
    this.a3c_1.q3c(headerOffset + 3 | 0, valueStartIndex);
    this.a3c_1.q3c(headerOffset + 4 | 0, valueEndIndex);
    this.a3c_1.q3c(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.a3c_1.q3c(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.y3b_1 = this.y3b_1 + 1 | 0;
  }
  r3c(headerOffset) {
    var nameStartIndex = this.a3c_1.f3c(headerOffset + 1 | 0);
    var nameEndIndex = this.a3c_1.f3c(headerOffset + 2 | 0);
    return this.x3b_1.c(nameStartIndex, nameEndIndex);
  }
  h3c(headerOffset) {
    var valueStartIndex = this.a3c_1.f3c(headerOffset + 3 | 0);
    var valueEndIndex = this.a3c_1.f3c(headerOffset + 4 | 0);
    return this.x3b_1.c(valueStartIndex, valueEndIndex);
  }
  l1g() {
    this.y3b_1 = 0;
    this.z3b_1 = 0;
    get_HeadersDataPool().k2o(this.a3c_1);
    this.a3c_1 = get_HeadersDataPool().j2o();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.b3c_1 = ArrayList.l2();
  }
  c3c() {
    return this.b3c_1.m2();
  }
  d3c(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.b3c_1.d2(get_IntArrayPool().j2o());
      }
       while (inductionVariable < subArraysCount);
  }
  f3c(index) {
    return this.b3c_1.k2(index / 768 | 0)[index % 768 | 0];
  }
  q3c(index, value) {
    this.b3c_1.k2(index / 768 | 0)[index % 768 | 0] = value;
  }
  e3c() {
    return sequence(HeadersData$headersStarts$slambda(this));
  }
  l1g() {
    var _iterator__ex2g4s = this.b3c_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().k2o(array);
    }
    this.b3c_1.c4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  v3c(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).h2o.call(this, instance);
  }
  h2o(instance) {
...
class ParserException extends IllegalStateException {
  constructor(message) {
    return new.target.g3d(message);
  }
  static g3d(message) {
    var $this = this.o(message);
    captureStack($this, $this.f3d_1);
    return $this;
  }
}
...
class Companion {
  h3d(from) {
    ...
    return this.u3d(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  u3d(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
...
class SubSequenceImpl {
  ...
  a() {
    return this.x3d_1 - this.w3d_1 | 0;
  }
  b(index) {
    var withOffset = index + this.w3d_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.x3d_1 - this.w3d_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.w1(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.z3d_1, this.w3d_1 + startIndex | 0, this.w3d_1 + endIndex | 0);
  }
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = toString(copy(this.z3d_1, this.w3d_1, this.x3d_1));
      this.y3d_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.z3d_1, this.w3d_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.y3d_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.z3d_1, this.w3d_1, this.x3d_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.p3c_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.p3c_1 + ')';
      throw IllegalArgumentException.w1(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.p3c_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.p3c_1 + ')';
      throw IllegalArgumentException.w1(toString(message_1));
    }
    return new SubSequenceImpl(this, startIndex, endIndex);
  }
  toString() {
    var tmp0_elvis_lhs = this.m3c_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.p3c_1));
      this.m3c_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.p3c_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.p3c_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.m3c_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.p3c_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.l3c_1).length - this.o3c_1 | 0] = value;
    this.m3c_1 = null;
    this.o3c_1 = this.o3c_1 - 1 | 0;
    this.p3c_1 = this.p3c_1 + 1 | 0;
    return this;
  }
  wf(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.o3c_1 | 0;
      ...
      this.o3c_1 = this.o3c_1 - bytesToCopy | 0;
    }
    this.m3c_1 = null;
    this.p3c_1 = this.p3c_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  i2(value) {
    if (value == null)
      return this;
    return this.wf(value, 0, charSequenceLength(value));
  }
  l1g() {
    var list = this.k3c_1;
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.j3c_1.k2o(list.k2(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.l3c_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.j3c_1.k2o(tmp0_safe_receiver);
      }
      this.l3c_1 = null;
    }
    this.n3c_1 = true;
...
class UnsupportedMediaTypeExceptionCIO extends IOException {
  constructor(message) {
    return new.target.p3d(message);
  }
  static p3d(message) {
    var $this = this.z2j(message);
    captureStack($this, $this.o3d_1);
    return $this;
  }
}
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.a3d_1 + ', end=' + this.b3d_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.y3b_1 >= $this.z3b_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.y3b_1;
  var prevData = $this.a3c_1;
  $this.y3b_1 = 0;
  $this.z3b_1 = imul($this.z3b_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().j2o();
  this_0.d3c(imul(prevData.c3c(), 2) | 1);
  tmp.a3c_1 = this_0;
  var _iterator__ex2g4s = prevData.e3c().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.g3c(prevData.f3c(headerOffset + 1 | 0), prevData.f3c(headerOffset + 2 | 0), prevData.f3c(headerOffset + 3 | 0), prevData.f3c(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().k2o(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.y3b_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.a3c_1.f3c(headerOffset + 1 | 0);
  var nameEndIndex = $this.a3c_1.f3c(headerOffset + 2 | 0);
  return equalsLowerCase($this.x3b_1, nameStartIndex, nameEndIndex, name);
}
function HeadersData$headersStarts$slambda(this$0) {
  return constructCallableReference(function *($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this$0.b3c_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this$0.f3c(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.mk(joinedIndex, $completion);
        }
...
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.i3c().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.i2(indent);
    out.i2(_this__u8e3s4.r3c(offset));
    out.i2(' => ');
    out.i2(_this__u8e3s4.h3c(offset));
    out.i2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.b3d_1 = builder.p3c_1;
      var rangeLength = range.b3d_1 - range.a3d_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.a3d_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.b3d_1;
      parseHeaderValue(builder, range);
      var valueStart = range.a3d_1;
      var valueEnd = range.b3d_1;
      range.a3d_1 = headerEnd;
      headers.g3c(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.q1i('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.a3d_1;
  var end = range.b3d_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.a3d_1)) {
      range.a3d_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.a3d_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.a3d_1 = valueStart;
  range.b3d_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.g3d("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
  ...
  if (tmp$ret$0) {
    throw ParserException.g3d('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.g3d('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.g3d('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.a3d_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.b3d_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.g3d('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.g3d('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().k2n_1, Companion_getInstance_0().j2n_1);
    versions = Companion_instance.h3d(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().q2y(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.p3d('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.j2g(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.z2j("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.z2j('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.z2j('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.u2g('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.q1i('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.z2j('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.z2j("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda($firstBoundary, $countedInput) {
  return constructCallableReference(function *($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl($firstBoundary, $countedInput, $this$writer.z2m_1, 8193n, $completion);
    yield* $this$writer.z2m_1.c2m($completion);
    return Unit_instance;
  }, 1);
}
function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  return constructCallableReference(function *($this$produce, $completion) {
    ...
    var readBeforeParse = countedInput.h2n();
    var firstBoundary = $boundaryPrefixed.k2g(get_PrefixString().m2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda(firstBoundary, countedInput)).p2m_1, $completion);
    var tmp;
    if (get_remaining(preambleData) > 0n) {
      tmp = yield* $this$produce.g27(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.s2l() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
    ...
    var tmp_0;
    if (!($totalLength == null)) {
      var consumedExceptEpilogue = subtract(countedInput.h2n(), readBeforeParse);
      var size = subtract($totalLength, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.z2j('Failed to parse multipart: prologue is too long');
      var tmp_1;
      if (size > 0n) {
        tmp_1 = yield* $this$produce.g27(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
      tmp_0 = tmp_1;
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      var tmp_2;
      if (!epilogueContent.w2g()) {
        tmp_2 = yield* $this$produce.g27(new Epilogue(epilogueContent), $completion);
      }
      tmp_0 = tmp_2;
    }
    return Unit_instance;
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.j2g(toByteArray_0('\r\n'));
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.l3c_1).length | 0];
}
function copy($this, startIndex, endIndex) {
  if (startIndex === endIndex)
    return '';
  var builder = StringBuilder.gb(endIndex - startIndex | 0);
  var buffer;
...
function bufferForIndex($this, index) {
  ...
  return list.k2(index / ensureNotNull($this.l3c_1).length | 0);
}
function throwSingleBuffer($this, index) {
  if ($this.n3c_1)
    throw IllegalStateException.o('Buffer is already released');
  throw IndexOutOfBoundsException.ld('' + index + ' is not in range [0; ' + currentPosition($this) + ')');
}
function nonFullBuffer($this) {
  return $this.o3c_1 === 0 ? appendNewArray($this) : ensureNotNull($this.l3c_1);
}
function appendNewArray($this) {
  var newBuffer = $this.j3c_1.j2o();
  var existing = $this.l3c_1;
  $this.l3c_1 = newBuffer;
  $this.o3c_1 = newBuffer.length;
  $this.n3c_1 = false;
  if (!(existing == null)) {
...
function currentPosition($this) {
  return ensureNotNull($this.l3c_1).length - $this.o3c_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.vd('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.vd('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.v34_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.v34_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().u34_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.u3d(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
