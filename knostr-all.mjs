import { NostrFactory_instance1id8lnm8qltzd as NostrFactory_instance } from './knostr-core.mjs';
import { NostrSocialFactory_instance2pr6ftmaiteq as NostrSocialFactory_instance } from './knostr-social.mjs';
import {
