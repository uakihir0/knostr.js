...
class HttpParameter {
  ...
  d42() {
    switch (this.c42()) {
      case 'txt':
        return Text_getInstance().t2y_1;
      case 'html':
        return Text_getInstance().w2y_1;
      case 'css':
        return Text_getInstance().u2y_1;
      case 'csv':
        return Text_getInstance().v2y_1;
      case 'jpg':
      case 'jpeg':
        return Image_getInstance().a2y_1;
      case 'png':
        return Image_getInstance().c2y_1;
      case 'gif':
        return Image_getInstance().x2x_1;
      case 'svg':
        return Image_getInstance().d2y_1;
      case 'mpeg':
        return Video_getInstance().d2z_1;
      case 'mp4':
        return Video_getInstance().e2z_1;
      case 'mov':
        return Video_getInstance().g2z_1;
      case 'webm':
        return ContentType.q2w('video', 'webm');
      case 'json':
        return Application_getInstance().y2w_1;
      case 'xml':
        return Application_getInstance().e2x_1;
      case 'zip':
        return Application_getInstance().h2x_1;
      case 'pdf':
        return Application_getInstance().k2x_1;
    }
    return Application_getInstance().b2x_1;
  }
}
class HttpRequest {
  constructor() {
    ...
    this.i42_1 = null;
    this.j42_1 = null;
    this.k42_1 = 'kHttpClient/1.0';
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.l42_1 = ArrayList.l2();
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_0.m42_1 = LinkedHashMap.ob();
    this.n42_1 = false;
    this.o42_1 = false;
    this.p42_1 = true;
    this.q42_1 = false;
  ...
  y42(key, value) {
    ...
    this.m42_1.g4(key, value);
    return this;
  }
  z42(key, value) {
    // Inline function 'kotlin.also' call
    this.l42_1.d2(Companion_instance.v41(key, toString(value)));
    return this;
  }
  w41(key, fileName, fileBody) {
    // Inline function 'kotlin.also' call
    this.l42_1.d2(Companion_instance.w41(key, fileName, fileBody));
    return this;
  }
  *a43($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().l34_1, $completion);
  }
  *b43($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().m34_1, $completion);
  }
}
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.u42_1 = Json(VOID, HttpResponse$Companion$mapper$lambda);
  }
  *v42(response, $completion) {
    var tmp = response.e3m().i37_1;
    var tmp_0 = toMap(response.k34());
    // Inline function 'io.ktor.client.call.body' call
    var tmp_1 = response.v3l();
    // Inline function 'io.ktor.util.reflect.typeInfo' call
    var tmp_2 = PrimitiveClasses_getInstance().lf();
    // Inline function 'io.ktor.util.reflect.typeOfOrNull' call
    var tmp_3;
    try {
      tmp_3 = createKType(PrimitiveClasses_getInstance().lf(), arrayOf([]), false);
    } catch ($p) {
      var tmp_4;
    ...
    var tmp_5 = yield* tmp_1.s3l(tmp$ret$1, $completion);
...
class HttpResponse {
  constructor(status, headers, body) {
    ...
    this.e43_1 = body;
    var tmp = this;
    tmp.f43_1 = lazy(HttpResponse$stringBody$delegate$lambda(this));
  }
  g43() {
    var tmp0 = this.f43_1;
    var tmp = KProperty1;
...
class WebsocketRequest {
  constructor() {
    ...
    this.l43_1 = null;
    this.m43_1 = null;
    this.n43_1 = 'kHttpClient/1.0';
    var tmp = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp.o43_1 = LinkedHashMap.ob();
    var tmp_0 = this;
    tmp_0.p43_1 = WebsocketRequest$textListener$slambda();
    var tmp_1 = this;
    tmp_1.q43_1 = WebsocketRequest$bytesListener$slambda();
    var tmp_2 = this;
    tmp_2.r43_1 = WebsocketRequest$onOpenListener$lambda;
    var tmp_3 = this;
    tmp_3.s43_1 = WebsocketRequest$onCloseListener$lambda;
    var tmp_4 = this;
    tmp_4.t43_1 = WebsocketRequest$onErrorListener$lambda;
    this.u43_1 = null;
    this.v43_1 = CompletableDeferred();
    this.w43_1 = false;
    this.x43_1 = CoroutineScope(Dispatchers_getInstance().e23_1.fm(SupervisorJob()));
  }
  y43(url) {
    // Inline function 'kotlin.also' call
    this.l43_1 = url;
  ...
  $l$block_0: {
    ...
    try {
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.collections.set' call
        $this.m42_1.g4('Accept', tmp0_safe_receiver);
      }
      var tmp1_safe_receiver = $this.k42_1;
      if (tmp1_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        var tmp0_0 = $this.m42_1;
        // Inline function 'kotlin.collections.set' call
        var key = 'User-Agent';
      ...
      if (!(req.i42_1 == null)) {
        ...
        takeFrom(this_0.w3k_1, URLBuilder(tmp_0));
      } else {
        url(this_0, req.e42_1, req.f42_1, req.h42_1, req.g42_1);
      }
      headers(this_0, HttpRequest$proceed$lambda_0(req));
      timeout(this_0, HttpRequest$proceed$lambda_1(req));
      if (!$this.n42_1 && !$this.o42_1 && req.l42_1.m2() === 1 && canSendOnly($this, first(req.l42_1))) {
        var param = first(req.l42_1);
        // Inline function 'io.ktor.client.request.setBody' call
        var body = new ByteArrayContent(ensureNotNull(param.b42_1), param.d42());
        if (body == null) {
          this_0.z3k_1 = NullBody_instance;
          // Inline function 'io.ktor.util.reflect.typeInfo' call
          ...
          if (body instanceof OutgoingContent) {
            ...
            this_0.q3o(tmp$ret$17);
          }
        }
      } else {
        if (method.equals(Companion_getInstance_1().l34_1)) {
          // Inline function 'kotlin.collections.forEach' call
          var _iterator__ex2g4s = req.l42_1.l1();
          while (_iterator__ex2g4s.m1()) {
            var element = _iterator__ex2g4s.n1();
            if (element.x41_1.s1_1 === 0) {
              this_0.w3k_1.x37_1.m2r(element.y41_1, ensureNotNull(element.z41_1));
            } else {
          ...
          while (_iterator__ex2g4s_1.m1()) {
            ...
            if (element_1.x41_1.equals(Type_PARAM_getInstance())) {
              destination_0.d2(element_1);
            }
          }
          var params = destination_0;
          // Inline function 'kotlin.collections.filter' call
          var tmp0_4 = req.l42_1;
          // Inline function 'kotlin.collections.filterTo' call
          ...
          while (_iterator__ex2g4s_2.m1()) {
            ...
            if (element_2.x41_1.equals(Type_FILE_getInstance())) {
          ...
          if (!queries.j1()) {
            ...
            while (_iterator__ex2g4s_3.m1()) {
              ...
              this_0.w3k_1.x37_1.m2r(element_3.y41_1, ensureNotNull(element_3.z41_1));
            }
          }
          var tmp_7;
          // Inline function 'kotlin.collections.isNotEmpty' call
          ...
          if (tmp_7) {
            if ($this.o42_1) {
              ...
              contentType(this_0, Application_getInstance().j2x_1);
              ...
              while (_iterator__ex2g4s_4.m1()) {
                ...
                this_1.m2r(element_4.y41_1, ensureNotNull(element_4.z41_1));
              }
              var tmp$ret$36 = this_1.n2z();
              // Inline function 'io.ktor.client.request.setBody' call
              ...
              if (body_0 == null) {
                ...
                if (body_0 instanceof OutgoingContent) {
                  ...
                  this_0.q3o(tmp$ret$44);
                }
              }
            } else {
              contentType(this_0, MultiPart_getInstance().m2y_1);
              ...
              while (_iterator__ex2g4s_5.m1()) {
                ...
                this_2.x3y(element_5.y41_1, ensureNotNull(element_5.z41_1));
              }
              // Inline function 'kotlin.collections.forEach' call
              var _iterator__ex2g4s_6 = files.l1();
              while (_iterator__ex2g4s_6.m1()) {
                var element_6 = _iterator__ex2g4s_6.n1();
                var tmp_14 = ensureNotNull(element_6.b42_1);
                // Inline function 'io.ktor.http.Companion.build' call
                Companion_getInstance();
                // Inline function 'kotlin.apply' call
                var this_3 = new HeadersBuilder();
                append(this_3, 'Content-Type', element_6.d42());
                this_3.m2r('Content-Disposition', 'filename=' + element_6.a42_1);
                var tmp$ret$53 = this_3.n2z();
                this_2.y3y(element_6.y41_1, tmp_14, tmp$ret$53);
              }
              // Inline function 'kotlin.collections.toTypedArray' call
              var this_4 = this_2.z3y();
      ...
      // Inline function 'io.ktor.client.request.request' call
      var tmp$ret$8 = yield* (new HttpStatement(this_0, tmp0)).i40($completion);
      tmp$ret$0 = yield* tmp.v42(tmp$ret$8, $completion);
      break $l$block_0;
    } catch ($p_5) {
...
function canSendOnly($this, param) {
  if (param.x41_1.equals(Type_JSON_getInstance()))
    return true;
  var tmp0_subject = param.d42();
  return tmp0_subject.equals(Application_getInstance().y2w_1) ? true : tmp0_subject.equals(Image_getInstance().a2y_1) ? true : tmp0_subject.equals(Image_getInstance().c2y_1) ? true : tmp0_subject.equals(Image_getInstance().x2x_1) ? true : tmp0_subject.equals(Video_getInstance().d2z_1) ? true : tmp0_subject.equals(Video_getInstance().e2z_1) ? true : tmp0_subject.equals(Video_getInstance().g2z_1) ? true : tmp0_subject.equals(ContentType.q2w('video', 'webm')) ? true : false;
}
function HttpRequest$proceed$lambda($req) {
  return ($this$HttpClient) => {
    ...
    $this$HttpClient.i3k_1 = $req.p42_1;
    return Unit_instance;
  };
}
function HttpRequest$proceed$lambda_0($req) {
  return ($this$headers) => {
    ...
    var _iterator__ex2g4s = $req.m42_1.u2().l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
...
function HttpRequest$proceed$lambda_1($req) {
  return ($this$timeout) => {
    $this$timeout.m3u($req.r42_1);
    $this$timeout.n3u($req.s42_1);
    $this$timeout.o3u($req.t42_1);
    return Unit_instance;
  };
}
function HttpResponse$Companion$mapper$lambda($this$Json) {
  $this$Json.c1h_1 = true;
  return Unit_instance;
}
...
function *start($this, $completion) {
  ...
  var tmp0_safe_receiver = $completion.ub().gc(Key_instance);
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.s1t(WebsocketRequest$start$lambda_3($this));
  }
  yield* opened.a1v($completion);
  yield* $this.v43_1.a1v($completion);
  return $this;
}
function buildUrl($this) {
  ...
  var s = $this.h43_1 === 'ws' || $this.h43_1 === 'wss' ? $this.h43_1 : 'wss';
  var tmp0 = $this.i43_1;
  var tmp$ret$2;
  $l$block: {
    // Inline function 'kotlin.checkNotNull' call
  ...
  var h = tmp$ret$2;
  var tmp1_safe_receiver = $this.k43_1;
  var tmp;
  if (tmp1_safe_receiver == null) {
    tmp = null;
  } else {
  ...
  var tmp3_safe_receiver = $this.j43_1;
  var tmp_0;
...
function WebsocketRequest$start$lambda($opened, this$0) {
  return (it) => {
    ...
    try {
      ...
      if ($p instanceof Error) {
        var e = $p;
        this$0.t43_1(RuntimeException.zc('onOpenListener failed', e));
        tmp_0 = Unit_instance;
      } else {
        throw $p;
      }
...
function WebsocketRequest$start$lambda_0(this$0, $opened) {
  return (it) => {
    ...
    var tmp;
    if (!$opened.l1t()) {
      $opened.u1y(RuntimeException.ea('WebSocket closed before open'));
      tmp = Unit_instance;
    }
    var tmp_0;
    if (!this$0.w43_1) {
      this$0.w43_1 = true;
      tmp_0 = this$0.s43_1(this$0);
    }
    return this$0.v43_1.t1y(Unit_instance);
  };
}
function WebsocketRequest$start$lambda_1(this$0, $opened) {
  return (_unused_var__etf5q3) => {
    var ex = RuntimeException.ea('WebSocket error');
    this$0.t43_1(ex);
    var tmp;
    if (!$opened.l1t()) {
      $opened.u1y(ex);
...
function WebsocketRequest$start$lambda$slambda(this$0, $data) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* this$0.p43_1($data, $completion);
    return Unit_instance;
  }, 1);
}
function WebsocketRequest$start$lambda$slambda_0(this$0, $bytes) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* this$0.q43_1($bytes, $completion);
    return Unit_instance;
  }, 1);
}
function WebsocketRequest$start$lambda_2(this$0) {
  return (event) => {
    ...
    if (!(data == null) ? typeof data === 'string' : false) {
      launch(this$0.x43_1, VOID, VOID, WebsocketRequest$start$lambda$slambda(this$0, data));
      tmp = Unit_instance;
    } else {
      if (data instanceof ArrayBuffer) {
        ...
        launch(this$0.x43_1, VOID, VOID, WebsocketRequest$start$lambda$slambda_0(this$0, bytes));
        tmp = Unit_instance;
      }
    }
    return Unit_instance;
...
function WebsocketRequest$start$lambda_3(this$0) {
  return (it) => {
    var tmp0_safe_receiver = this$0.u43_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.close();
