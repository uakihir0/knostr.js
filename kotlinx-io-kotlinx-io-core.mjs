...
function write$default(source, startIndex, endIndex, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.j2j(source, startIndex, endIndex);
    tmp = Unit_instance;
  } else {
    tmp = $super.j2j.call(this, source, startIndex, endIndex);
  }
  return tmp;
}
class Buffer {
  ...
  b2i(byteCount) {
    ...
    if (this.m2() < byteCount) {
      throw EOFException.y2h("Buffer doesn't contain required number of bytes (size: " + this.m2().toString() + ', required: ' + byteCount.toString() + ')');
    }
  }
  c2i(byteCount) {
    // Inline function 'kotlin.require' call
  ...
  d2i() {
    ...
    var v = segment.m2i();
    this.u2h_1 = subtract(this.u2h_1, 1n);
    if (segmentSize === 1) {
      this.l2i();
    }
    return v;
  ...
  n2i() {
    ...
    if (segmentSize < 2) {
      ...
      var tmp_0 = (this.d2i() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.d2i() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.o2i();
    this.u2h_1 = subtract(this.u2h_1, 2n);
    if (segmentSize === 2) {
      this.l2i();
    }
    return v;
  ...
  q2i(out, startIndex, endIndex) {
    checkBounds(this.m2(), startIndex, endIndex);
    if (startIndex === endIndex)
      return Unit_instance;
    var currentOffset = startIndex;
    var remainingByteCount = subtract(endIndex, startIndex);
    out.u2h_1 = add(out.u2h_1, remainingByteCount);
    var s = this.s2h_1;
    while (currentOffset >= fromInt(ensureNotNull(s).g2i_1 - s.f2i_1 | 0)) {
      currentOffset = subtract(currentOffset, fromInt(s.g2i_1 - s.f2i_1 | 0));
      s = s.j2i_1;
    }
    while (remainingByteCount > 0n) {
      var copy = ensureNotNull(s).r2i();
      copy.f2i_1 = copy.f2i_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.f2i_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.g2i_1;
      tmp.g2i_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.s2h_1 == null) {
        out.s2h_1 = copy;
        out.t2h_1 = copy;
      } else if (false) {
        out.t2h_1 = ensureNotNull(out.t2h_1).s2i(copy).t2i();
        if (ensureNotNull(out.t2h_1).k2i_1 == null) {
          out.s2h_1 = out.t2h_1;
        }
      } else {
        out.t2h_1 = ensureNotNull(out.t2h_1).s2i(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.g2i_1 - copy.f2i_1 | 0));
      currentOffset = 0n;
      s = s.j2i_1;
    }
  }
  u2i() {
    ...
    if (result === 0n)
      return 0n;
    var tail = ensureNotNull(this.t2h_1);
    if (tail.g2i_1 < 8192 && tail.i2i_1) {
      result = subtract(result, fromInt(tail.g2i_1 - tail.f2i_1 | 0));
    }
    return result;
  }
  v2i(position) {
    if (position < 0n || position >= this.m2()) {
      throw IndexOutOfBoundsException.wd('position (' + position.toString() + ') is not within the range [0..size(' + this.m2().toString() + '))');
    }
    if (position === 0n) {
      return ensureNotNull(this.s2h_1).w2i(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.s2h_1 == null) {
        return ensureNotNull(null).w2i(convertToInt(subtract(position, -1n)));
      }
      if (subtract(this.m2(), position) < position) {
        var s = this.t2h_1;
        var offset = this.m2();
        $l$loop: while (!(s == null) && offset > position) {
          offset = subtract(offset, fromInt(s.g2i_1 - s.f2i_1 | 0));
          if (offset <= position)
            break $l$loop;
          s = s.k2i_1;
        }
        var tmp0 = s;
        var offset_0 = offset;
        return ensureNotNull(tmp0).w2i(convertToInt(subtract(position, offset_0)));
      } else {
        var s_0 = this.s2h_1;
        var offset_1 = 0n;
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.g2i_1 - s_0.f2i_1 | 0;
        ...
        return ensureNotNull(tmp0_1).w2i(convertToInt(subtract(position, offset_2)));
      }
    }
  }
  x3() {
    return this.x2i(this.m2());
  }
  x2i(byteCount) {
    ...
    while (remainingByteCount > 0n) {
      ...
      var tmp;
      if (tmp0_elvis_lhs == null) {
        throw EOFException.y2h('Buffer exhausted before skipping ' + byteCount.toString() + ' bytes.');
      } else {
        tmp = tmp0_elvis_lhs;
      }
      var head = tmp;
      ...
      var b = head.g2i_1 - head.f2i_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = tmp0 <= b_0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.u2h_1 = subtract(this.u2h_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.f2i_1 = head.f2i_1 + toSkip | 0;
      if (head.f2i_1 === head.g2i_1) {
        this.l2i();
      }
    }
  }
  y2i(sink, startIndex, endIndex) {
    ...
    s.z2i(sink, startIndex, startIndex + toCopy | 0);
    this.u2h_1 = subtract(this.u2h_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.l2i();
    }
    return toCopy;
  ...
  c2j(sink, byteCount) {
    ...
    if (this.m2() < byteCount) {
      sink.b2j(this, this.m2());
      throw EOFException.y2h('Buffer exhausted before writing ' + byteCount.toString() + ' bytes. Only ' + this.m2().toString() + ' bytes were written.');
    }
    sink.b2j(this, byteCount);
  }
  d2j(sink) {
  ...
  f2j(minimumCapacity) {
    ...
    if (this.t2h_1 == null) {
      var result = SegmentPool_instance.i2j();
      this.s2h_1 = result;
      this.t2h_1 = result;
      return result;
    }
    var t = ensureNotNull(this.t2h_1);
    if ((t.g2i_1 + minimumCapacity | 0) > 8192 || !t.i2i_1) {
      var newTail = t.s2i(SegmentPool_instance.i2j());
      this.t2h_1 = newTail;
      return newTail;
    }
    return t;
  }
  j2j(source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.k2j();
      var toCopy = Math.min(tmp0, b);
      tail.l2j(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.u2h_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.u2h_1 = add(tmp0_0, fromInt(other));
  }
  n2j(source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(byteCount >= 0n)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      var read = source.a2j(this, remainingByteCount);
      if (read === -1n) {
        throw EOFException.y2h('Source exhausted before reading ' + byteCount.toString() + ' bytes. ' + ('Only ' + subtract(byteCount, remainingByteCount).toString() + ' were read.'));
      }
      remainingByteCount = subtract(remainingByteCount, read);
    }
  }
  b2j(source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException.w1(toString(message));
    }
    checkOffsetAndCount(source.u2h_1, 0n, byteCount);
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      if (remainingByteCount < fromInt(ensureNotNull(source.s2h_1).m2())) {
        var tail = this.t2h_1;
        var tmp;
        if (!(tail == null) && tail.i2i_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.g2i_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.o2j() ? 0 : tail.f2i_1;
          tmp = subtract(tmp0_0, fromInt(other_0)) <= 8192n;
        } else {
          tmp = false;
        }
        if (tmp) {
          ensureNotNull(source.s2h_1).q2j(tail, convertToInt(remainingByteCount));
          source.u2h_1 = subtract(source.u2h_1, remainingByteCount);
          this.u2h_1 = add(this.u2h_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.s2h_1 = ensureNotNull(source.s2h_1).p2j(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.s2h_1);
      var movedByteCount = fromInt(segmentToMove.m2());
      source.s2h_1 = segmentToMove.r2j();
      if (source.s2h_1 == null) {
        source.t2h_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.s2h_1 == null) {
        this.s2h_1 = segmentToMove;
        this.t2h_1 = segmentToMove;
      } else if (true) {
        this.t2h_1 = ensureNotNull(this.t2h_1).s2i(segmentToMove).t2i();
        if (ensureNotNull(this.t2h_1).k2i_1 == null) {
          this.s2h_1 = this.t2h_1;
        }
      } else {
        this.t2h_1 = ensureNotNull(this.t2h_1).s2i(segmentToMove);
      }
      source.u2h_1 = subtract(source.u2h_1, movedByteCount);
      this.u2h_1 = add(this.u2h_1, movedByteCount);
  ...
  s2j(source) {
    ...
    $l$loop: while (true) {
      var readCount = source.a2j(this, 8192n);
      if (readCount === -1n)
        break $l$loop;
  ...
  t2j(byte) {
    this.f2j(1).u2j(byte);
    this.u2h_1 = add(this.u2h_1, 1n);
  }
  v2j(short) {
    this.f2j(2).w2j(short);
    this.u2h_1 = add(this.u2h_1, 2n);
  }
  y5() {
    return Unit_instance;
  }
  toString() {
    ...
    var builder = StringBuilder.lb(imul(len, 2) + (this.m2() > fromInt(maxPrintableBytes) ? 1 : 0) | 0);
    var bytesWritten = 0;
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.m2()) {
        ...
        var b_0 = tmp0.x2j(segment, _unary__edvuaz);
  ...
  l2i() {
    var oldHead = ensureNotNull(this.s2h_1);
    var nextHead = oldHead.j2i_1;
    this.s2h_1 = nextHead;
    if (nextHead == null) {
      this.t2h_1 = null;
    } else {
    ...
    oldHead.j2i_1 = null;
    SegmentPool_instance.y2j(oldHead);
  }
  z2j() {
    var oldTail = ensureNotNull(this.t2h_1);
    var newTail = oldTail.k2i_1;
    this.t2h_1 = newTail;
    if (newTail == null) {
      this.s2h_1 = null;
    } else {
    ...
    oldTail.k2i_1 = null;
    SegmentPool_instance.y2j(oldTail);
  }
}
class PeekSource {
  constructor(upstream) {
    this.a2k_1 = upstream;
    this.b2k_1 = this.a2k_1.z2h();
    this.c2k_1 = this.b2k_1.s2h_1;
    var tmp = this;
    var tmp0_safe_receiver = this.b2k_1.s2h_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.f2i_1;
    tmp.d2k_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.e2k_1 = false;
    this.f2k_1 = 0n;
  }
  a2j(sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.c2k_1 == null || (this.c2k_1 === this.b2k_1.s2h_1 && this.d2k_1 === ensureNotNull(this.b2k_1.s2h_1).f2i_1))) {
    ...
    if (!this.a2k_1.c2i(tmp$ret$7))
      return -1n;
    if (this.c2k_1 == null && !(this.b2k_1.s2h_1 == null)) {
      this.c2k_1 = this.b2k_1.s2h_1;
      this.d2k_1 = ensureNotNull(this.b2k_1.s2h_1).f2i_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.b2k_1.m2(), this.f2k_1);
    var toCopy = byteCount <= b ? byteCount : b;
    this.b2k_1.q2i(sink, this.f2k_1, add(this.f2k_1, toCopy));
    this.f2k_1 = add(this.f2k_1, toCopy);
    return toCopy;
  }
  y5() {
    this.e2k_1 = true;
...
class RealSource {
  ...
  a2j(sink, byteCount) {
    ...
    if (this.i2k_1.m2() === 0n) {
      var read = this.g2k_1.a2j(this.i2k_1, 8192n);
      if (read === -1n)
        return -1n;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.i2k_1.a2j(sink, toRead);
  }
  a2i() {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    return this.i2k_1.a2i() && this.g2k_1.a2j(this.i2k_1, 8192n) === -1n;
  }
  b2i(byteCount) {
    if (!this.c2i(byteCount))
      throw EOFException.y2h("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  }
  c2i(byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    while (this.i2k_1.m2() < byteCount) {
      if (this.g2k_1.a2j(this.i2k_1, 8192n) === -1n)
        return false;
    }
    return true;
  }
  ...
  y2i(sink, startIndex, endIndex) {
    ...
    return this.i2k_1.y2i(sink, startIndex, startIndex + toRead | 0);
  }
  c2j(sink, byteCount) {
    try {
      this.b2i(byteCount);
      ...
      if ($p instanceof EOFException) {
        var e = $p;
        sink.b2j(this.i2k_1, this.i2k_1.m2());
        throw e;
      } else {
        throw $p;
      }
    }
    this.i2k_1.c2j(sink, byteCount);
  }
  d2j(sink) {
    var totalBytesWritten = 0n;
    while (!(this.g2k_1.a2j(this.i2k_1, 8192n) === -1n)) {
      var emitByteCount = this.i2k_1.u2i();
      if (emitByteCount > 0n) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.b2j(this.i2k_1, emitByteCount);
      }
    }
    if (this.i2k_1.m2() > 0n) {
      totalBytesWritten = add(totalBytesWritten, this.i2k_1.m2());
      sink.b2j(this.i2k_1, this.i2k_1.m2());
    }
  ...
  toString() {
    return 'buffered(' + toString(this.g2k_1) + ')';
  }
}
class Companion {
  constructor() {
...
class Segment {
  o2j() {
    ...
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.n2k();
    return tmp1_elvis_lhs == null ? false : tmp1_elvis_lhs;
  }
  static m2k() {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.e2i_1 = new Int8Array(8192);
    $this.i2i_1 = true;
    $this.h2i_1 = null;
    return $this;
  }
  static o2k(data, pos, limit, shareToken, owner) {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.e2i_1 = data;
    $this.f2i_1 = pos;
    $this.g2i_1 = limit;
    $this.h2i_1 = shareToken;
    $this.i2i_1 = owner;
    return $this;
  }
  r2i() {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = SegmentPool_instance.p2k();
      this.h2i_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    ...
    var t = tmp;
    var tmp_0 = this.f2i_1;
    var tmp_1 = this.g2i_1;
    // Inline function 'kotlin.also' call
    t.q2k();
    return Segment.o2k(this.e2i_1, tmp_0, tmp_1, t, false);
  }
  r2j() {
    var result = this.j2i_1;
    if (!(this.k2i_1 == null)) {
      ensureNotNull(this.k2i_1).j2i_1 = this.j2i_1;
    }
    if (!(this.j2i_1 == null)) {
      ensureNotNull(this.j2i_1).k2i_1 = this.k2i_1;
    }
    this.j2i_1 = null;
    this.k2i_1 = null;
    return result;
  ...
  s2i(segment) {
    segment.k2i_1 = this;
    segment.j2i_1 = this.j2i_1;
    if (!(this.j2i_1 == null)) {
      ensureNotNull(this.j2i_1).k2i_1 = segment;
    }
    this.j2i_1 = segment;
    return segment;
  }
  p2j(byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.g2i_1 - this.f2i_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.i2j();
      var tmp0 = this.e2i_1;
      var tmp2 = prefix.e2i_1;
      var tmp5 = this.f2i_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.f2i_1 + byteCount | 0;
    ...
    prefix.g2i_1 = prefix.f2i_1 + byteCount | 0;
    this.f2i_1 = this.f2i_1 + byteCount | 0;
    if (!(this.k2i_1 == null)) {
      ensureNotNull(this.k2i_1).s2i(prefix);
    } else {
      prefix.j2i_1 = this;
      this.k2i_1 = prefix;
    }
  ...
  t2i() {
    ...
    if (!ensureNotNull(this.k2i_1).i2i_1)
      return this;
    var byteCount = this.g2i_1 - this.f2i_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.k2i_1).g2i_1 | 0) + (ensureNotNull(this.k2i_1).o2j() ? 0 : ensureNotNull(this.k2i_1).f2i_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.k2i_1;
    this.q2j(ensureNotNull(predecessor), byteCount);
    var successor = this.r2j();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException.o('Check failed.');
    }
    SegmentPool_instance.y2j(this);
    return predecessor;
  }
  u2j(byte) {
    var _unary__edvuaz = this.g2i_1;
    this.g2i_1 = _unary__edvuaz + 1 | 0;
    this.e2i_1[_unary__edvuaz] = byte;
  }
  w2j(short) {
    var data = this.e2i_1;
    var limit = this.g2i_1;
  ...
  m2i() {
    ...
    return this.e2i_1[_unary__edvuaz];
  }
  o2i() {
    var data = this.e2i_1;
    var pos = this.f2i_1;
  ...
  q2j(sink, byteCount) {
    ...
    if ((sink.g2i_1 + byteCount | 0) > 8192) {
      if (sink.o2j())
        throw IllegalArgumentException.ld();
      if (((sink.g2i_1 + byteCount | 0) - sink.f2i_1 | 0) > 8192)
        throw IllegalArgumentException.ld();
      var tmp0 = sink.e2i_1;
      var tmp2 = sink.e2i_1;
      var tmp5 = sink.f2i_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.g2i_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.g2i_1 = sink.g2i_1 - sink.f2i_1 | 0;
      sink.f2i_1 = 0;
    }
    var tmp0_0 = this.e2i_1;
    var tmp2_0 = sink.e2i_1;
    var tmp4 = sink.g2i_1;
    var tmp6 = this.f2i_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.f2i_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.g2i_1 = sink.g2i_1 + byteCount | 0;
    this.f2i_1 = this.f2i_1 + byteCount | 0;
  }
  z2i(dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.e2i_1;
    var tmp6 = this.f2i_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.f2i_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.f2i_1 = this.f2i_1 + len | 0;
  }
  l2j(src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.e2i_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.g2i_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.g2i_1 = this.g2i_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  }
  m2() {
    return this.g2i_1 - this.f2i_1 | 0;
  }
  k2j() {
    return this.e2i_1.length - this.g2i_1 | 0;
  }
  r2k(readOnly) {
    return this.e2i_1;
  }
  w2i(index) {
    return this.e2i_1[this.f2i_1 + index | 0];
  }
  s2k(index, value) {
    this.e2i_1[this.g2i_1 + index | 0] = value;
  }
  t2k(index, b0, b1) {
    var d = this.e2i_1;
    var l = this.g2i_1;
...
class SegmentReadContextImpl$1 {
  x2j(segment, offset) {
    return segment.w2i(offset);
  }
}
class SegmentWriteContextImpl$1 {
  z2k(segment, offset, value) {
    segment.s2k(offset, value);
  }
  y2k(segment, offset, b0, b1) {
    segment.t2k(offset, b0, b1);
  }
  x2k(segment, offset, b0, b1, b2) {
    segment.u2k(offset, b0, b1, b2);
  }
  w2k(segment, offset, b0, b1, b2, b3) {
    segment.v2k(offset, b0, b1, b2, b3);
  }
}
class BufferIterationContextImpl$1 {
  x2j(segment, offset) {
    return get_SegmentReadContextImpl().x2j(segment, offset);
  }
}
...
function checkBounds(size, startIndex, endIndex) {
  ...
  if (startIndex < 0n || endIndex > size) {
    throw IndexOutOfBoundsException.wd('startIndex (' + startIndex.toString() + ') and endIndex (' + endIndex.toString() + ') are not within the range [0..size(' + size.toString() + '))');
  }
  if (startIndex > endIndex) {
  ...
  $l$block_1: {
    ...
    if (subtract(_this__u8e3s4.m2(), startIndex) < startIndex) {
      ...
      do {
        ...
        segment_0 = segment_0.j2i_1;
      }
       while (!(segment_0 == null) && offset_1 < endOffset);
      return -1n;
    } else {
      var s_0 = _this__u8e3s4.s2h_1;
      var offset_2 = 0n;
      $l$loop_0: while (!(s_0 == null)) {
        var tmp0_4 = offset_2;
        // Inline function 'kotlin.Long.plus' call
        var other_1 = s_0.g2i_1 - s_0.f2i_1 | 0;
...
function readByteString(_this__u8e3s4, byteCount) {
  return UnsafeByteStringOperations_instance.r2h(readByteArray_0(_this__u8e3s4, byteCount));
}
...
function init_kotlinx_io_Segment(_this__u8e3s4) {
  _this__u8e3s4.f2i_1 = 0;
  _this__u8e3s4.g2i_1 = 0;
  _this__u8e3s4.h2i_1 = null;
  _this__u8e3s4.i2i_1 = false;
  _this__u8e3s4.j2i_1 = null;
  _this__u8e3s4.k2i_1 = null;
}
...
function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
  ...
  var p = _this__u8e3s4.f2i_1;
  var data = _this__u8e3s4.r2k(true);
...
function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
  ...
  $l$loop: while (true) {
    ...
    if (offset < endIndex) {
      ...
      tmp_0 = _this__u8e3s4.c2i(tmp$ret$2);
    } else {
      tmp_0 = false;
    }
    if (!tmp_0) {
    ...
    var tmp_1 = _this__u8e3s4.z2h();
    var tmp_2 = offset;
    // Inline function 'kotlin.comparisons.minOf' call
    var b = _this__u8e3s4.z2h().m2();
    var tmp$ret$3 = endIndex <= b ? endIndex : b;
    var idx = indexOf(tmp_1, byte, tmp_2, tmp$ret$3);
    if (!(idx === -1n)) {
      return idx;
    }
    offset = _this__u8e3s4.z2h().m2();
  }
  return -1n;
}
function readByteArrayImpl(_this__u8e3s4, size) {
  ...
  if (size === -1) {
    ...
    while (_this__u8e3s4.z2h().m2() < 2147483647n && _this__u8e3s4.c2i(fetchSize)) {
      // Inline function 'kotlin.Long.times' call
      var this_0 = fetchSize;
      fetchSize = multiply(this_0, fromInt(2));
    }
    // Inline function 'kotlin.check' call
    if (!(_this__u8e3s4.z2h().m2() < 2147483647n)) {
      var message = "Can't create an array of size " + _this__u8e3s4.z2h().m2().toString();
      throw IllegalStateException.o(toString(message));
    }
    arraySize = convertToInt(_this__u8e3s4.z2h().m2());
  } else {
    _this__u8e3s4.b2i(fromInt(size));
  }
  var array = new Int8Array(arraySize);
  readTo(_this__u8e3s4.z2h(), array);
  return array;
}
function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
  ...
  while (offset < endIndex) {
    var bytesRead = _this__u8e3s4.y2i(sink, offset, endIndex);
    if (bytesRead === -1) {
      throw EOFException.y2h('Source exhausted before reading ' + (endIndex - startIndex | 0) + ' bytes. ' + ('Only ' + bytesRead + ' bytes were read.'));
    }
    offset = offset + bytesRead | 0;
  }
}
function readString(_this__u8e3s4, byteCount) {
  _this__u8e3s4.b2i(byteCount);
  return commonReadUtf8(_this__u8e3s4.z2h(), byteCount);
}
function readString_0(_this__u8e3s4) {
  _this__u8e3s4.c2i(9223372036854775807n);
  return commonReadUtf8(_this__u8e3s4.z2h(), _this__u8e3s4.z2h().m2());
}
  ...
  while (i < endIndex) {
    ...
    if (c < 128) {
      $l$block_0: {
        ...
        ctx.z2k(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
        $l$loop: while (i < runLimit) {
          ...
          ctx.z2k(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
        }
        var bytesWritten = i + segmentOffset | 0;
        if (bytesWritten === 1) {
          tail.g2i_1 = tail.g2i_1 + bytesWritten | 0;
          var tmp = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_3 = this_0.u2h_1;
          tmp.u2h_1 = add(this_3, fromInt(bytesWritten));
          break $l$block_0;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten ? bytesWritten <= tail.k2j() : false)) {
          var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.k2j();
          throw IllegalStateException.o(toString(message));
        }
        if (!(bytesWritten === 0)) {
          tail.g2i_1 = tail.g2i_1 + bytesWritten | 0;
          var tmp_0 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_4 = this_0.u2h_1;
          tmp_0.u2h_1 = add(this_4, fromInt(bytesWritten));
          break $l$block_0;
        }
        if (isEmpty(tail)) {
          this_0.z2j();
      ...
      $l$block_2: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_0 = this_0.f2j(2);
        get_SegmentWriteContextImpl().y2k(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
        var bytesWritten_0 = 2;
        if (bytesWritten_0 === 2) {
          tail_0.g2i_1 = tail_0.g2i_1 + bytesWritten_0 | 0;
          var tmp_1 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_5 = this_0.u2h_1;
          tmp_1.u2h_1 = add(this_5, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.k2j() : false)) {
          var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.k2j();
        ...
        if (!(bytesWritten_0 === 0)) {
          ...
          var tmp_2 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_6 = this_0.u2h_1;
          tmp_2.u2h_1 = add(this_6, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        if (isEmpty(tail_0)) {
          this_0.z2j();
      ...
      $l$block_4: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_1 = this_0.f2j(3);
        get_SegmentWriteContextImpl().x2k(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
        var bytesWritten_1 = 3;
        if (bytesWritten_1 === 3) {
          tail_1.g2i_1 = tail_1.g2i_1 + bytesWritten_1 | 0;
          var tmp_3 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_7 = this_0.u2h_1;
          tmp_3.u2h_1 = add(this_7, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.k2j() : false)) {
          var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.k2j();
          throw IllegalStateException.o(toString(message_1));
        }
        if (!(bytesWritten_1 === 0)) {
          tail_1.g2i_1 = tail_1.g2i_1 + bytesWritten_1 | 0;
          var tmp_4 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_8 = this_0.u2h_1;
          tmp_4.u2h_1 = add(this_8, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        if (isEmpty(tail_1)) {
          this_0.z2j();
      ...
      if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
        ...
        this_0.t2j(toByte(tmp$ret$29));
        i = i + 1 | 0;
      } else {
        var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
        $l$block_6: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_2 = this_0.f2j(4);
          get_SegmentWriteContextImpl().w2k(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
          var bytesWritten_2 = 4;
          if (bytesWritten_2 === 4) {
            tail_2.g2i_1 = tail_2.g2i_1 + bytesWritten_2 | 0;
            var tmp_6 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_11 = this_0.u2h_1;
            tmp_6.u2h_1 = add(this_11, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.k2j() : false)) {
            var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.k2j();
          ...
          if (!(bytesWritten_2 === 0)) {
            ...
            var tmp_7 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_12 = this_0.u2h_1;
            tmp_7.u2h_1 = add(this_12, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          if (isEmpty(tail_2)) {
            this_0.z2j();
...
function commonToUtf8String(_this__u8e3s4, beginIndex, endIndex) {
  ...
  if (beginIndex < 0 || endIndex > _this__u8e3s4.length || beginIndex > endIndex) {
    throw IndexOutOfBoundsException.wd('size=' + _this__u8e3s4.length + ' beginIndex=' + beginIndex + ' endIndex=' + endIndex);
  }
...
function init_kotlinx_io_IOException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.b2l_1);
}
function init_kotlinx_io_EOFException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.x2h_1);
}
...
protoOf(Buffer).m2j = write$default;
...
initMetadataForClass(IOException, 'IOException', IOException.c2l);
initMetadataForClass(EOFException, 'EOFException', EOFException.f2l);
