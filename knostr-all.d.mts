...
export declare interface EventResource {
    ...
    queryEventsWithTimeout(filters: KtList<NostrFilter>, timeoutMs: bigint): Promise<Response<KtList<NostrEvent>>>;
...
export declare abstract class NostrMediaTags {
    static readonly getInstance: () => typeof NostrMediaTags.$metadata$.type;
    private constructor();
}
export declare namespace NostrMediaTags {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        abstract class type extends KtSingleton<constructor>() {
            private constructor();
        ...
        abstract class constructor {
            imeta(media: NostrMedia): KtList<string>;
            private constructor();
        }
    }
}
...
export declare class NostrSocialConfig {
    constructor();
    get mediaUploadServerUrl(): string;
    set mediaUploadServerUrl(value: string);
    ...
    get noteCacheTtlMs(): bigint;
    set noteCacheTtlMs(value: bigint);
    get noteStatsCacheTtlMs(): bigint;
    set noteStatsCacheTtlMs(value: bigint);
    get referencedEventLookupTimeoutMs(): bigint;
    set referencedEventLookupTimeoutMs(value: bigint);
    get socialCache(): Nullable<SocialCache>;
    set socialCache(value: Nullable<SocialCache>);
    get deferredEnrichmentEnabled(): boolean;
    set deferredEnrichmentEnabled(value: boolean);
    get deferredEnrichmentMaxAttempts(): number;
    set deferredEnrichmentMaxAttempts(value: number);
    get deferredEnrichmentInitialDelayMs(): bigint;
    set deferredEnrichmentInitialDelayMs(value: bigint);
    get deferredEnrichmentBackoffMultiplier(): number;
    set deferredEnrichmentBackoffMultiplier(value: number);
}
export declare namespace NostrSocialConfig {
    ...
    namespace Companion {
        ...
        namespace $metadata$ {
            abstract class constructor {
                get DEFAULT_MEDIA_UPLOAD_SERVER_URL(): string;
                private constructor();
            }
        }
    }
...
export declare interface EnrichmentResource {
    onUpdateCallback: Nullable<(p0: SocialDataBatch) => void>;
    request(request: SocialDataRequest, forceRefresh?: boolean): void;
    cancelPending(): Promise<void>;
    close(): void;
    readonly __doNotUseOrImplementIt: {
        readonly "work.socialhub.knostr.social.api.EnrichmentResource": unique symbol;
    };
}
export declare interface FeedResource {
    ...
    replyWithTags(content: string, tags: KtList<KtList<string>> | undefined, replyToEventId: string, rootEventId?: Nullable<string>, contentWarning?: Nullable<string>, expiry?: Nullable<bigint>, sensitive?: boolean): Promise<Response<NostrEvent>>;
...
export declare interface MediaResource {
    uploadToConfiguredServer(fileData: Int8Array, fileName: string, mimeType: string, description?: string): Promise<Response<NostrMedia>>;
    ...
    uploadAndPost(fileData: Int8Array, fileName: string, mimeType: string, content?: string, description?: string, tags?: KtList<KtList<string>>, contentWarning?: Nullable<string>, expiry?: Nullable<bigint>, sensitive?: boolean): Promise<Response<NostrMediaPost>>;
    uploadManyAndPost(uploads: KtList<NostrMediaUpload>, content?: string, tags?: KtList<KtList<string>>, contentWarning?: Nullable<string>, expiry?: Nullable<bigint>, sensitive?: boolean): Promise<Response<NostrMediaPost>>;
    uploadAndReply(uploads: KtList<NostrMediaUpload>, replyToEventId: string, content?: string, rootEventId?: Nullable<string>, tags?: KtList<KtList<string>>, contentWarning?: Nullable<string>, expiry?: Nullable<bigint>, sensitive?: boolean): Promise<Response<NostrMediaPost>>;
...
export declare interface SocialCache {
    get(request: SocialDataRequest): Promise<SocialDataBatch>;
    put(batch: SocialDataBatch): Promise<void>;
    remove(request: SocialDataRequest): Promise<void>;
    readonly __doNotUseOrImplementIt: {
        readonly "work.socialhub.knostr.social.api.SocialCache": unique symbol;
    };
}
...
export declare class NostrMediaPost {
    constructor(media: NostrMedia, event: NostrEvent);
    get event(): NostrEvent;
    set event(value: NostrEvent);
    get media(): NostrMedia;
    get medias(): KtList<NostrMedia>;
}
export declare namespace NostrMediaPost {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => NostrMediaPost;
    }
}
export declare class NostrMediaUpload {
    constructor(fileData: Int8Array, fileName: string, mimeType: string, description?: string);
    get fileData(): Int8Array;
    get fileName(): string;
    get mimeType(): string;
    get description(): string;
}
export declare namespace NostrMediaUpload {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => NostrMediaUpload;
    }
}
...
export declare class NostrNoteStats {
    constructor(eventId: string, likeCount?: number, replyCount?: number, repostCount?: number);
    get eventId(): string;
...
export declare namespace NostrNoteStats {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => NostrNoteStats;
    }
}
...
export declare class SocialDataBatch {
    constructor(users?: KtList<NostrUser>, notes?: KtList<NostrNote>, noteStats?: KtList<NostrNoteStats>);
    get users(): KtList<NostrUser>;
    set users(value: KtList<NostrUser>);
    get notes(): KtList<NostrNote>;
    set notes(value: KtList<NostrNote>);
    get noteStats(): KtList<NostrNoteStats>;
    set noteStats(value: KtList<NostrNoteStats>);
    isEmpty(): boolean;
}
export declare namespace SocialDataBatch {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => SocialDataBatch;
    }
}
export declare class SocialDataRequest {
    constructor(userPubkeys?: KtList<string>, noteIds?: KtList<string>, noteStatsEventIds?: KtList<string>);
    get userPubkeys(): KtList<string>;
    set userPubkeys(value: KtList<string>);
    get noteIds(): KtList<string>;
    set noteIds(value: KtList<string>);
    get noteStatsEventIds(): KtList<string>;
    set noteStatsEventIds(value: KtList<string>);
    isEmpty(): boolean;
}
export declare namespace SocialDataRequest {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => SocialDataRequest;
    }
}
