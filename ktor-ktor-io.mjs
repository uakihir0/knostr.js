...
class Companion {
  constructor() {
    ...
    this.c2k_1 = new Closed(null);
    var tmp = this;
    // Inline function 'kotlin.Companion.success' call
    tmp.d2k_1 = _Result___init__impl__xyqfz8(Unit_instance);
  }
}
class Empty {
  toString() {
...
class Closed {
  ...
  toString() {
    return 'Closed(cause=' + toString(this.e2k_1) + ')';
  }
  hashCode() {
    return this.e2k_1 == null ? 0 : hashCode(this.e2k_1);
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof Closed))
      return false;
    if (!equals(this.e2k_1, other.e2k_1))
      return false;
    return true;
  }
}
class Task {}
function resume() {
  return this.g2k().wb(Companion_getInstance().d2k_1);
}
function resume_0(throwable) {
  ...
  return tmp.wb(tmp1_elvis_lhs == null ? Companion_getInstance().d2k_1 : tmp1_elvis_lhs.dt_1);
}
class Read {
  constructor(continuation) {
    this.k2k_1 = continuation;
    this.l2k_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('ReadTask 0x' + toString_0(hashCode(this.k2k_1), 16));
...
class Write {
  constructor(continuation) {
    this.m2k_1 = continuation;
    this.n2k_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('WriteTask 0x' + toString_0(hashCode(this.m2k_1), 16));
      stackTraceToString(this_0);
      tmp.n2k_1 = this_0;
    }
  }
...
function awaitContent$default(min, $completion, $super) {
  min = min === VOID ? 1 : min;
  return $super === VOID ? this.t2l(min, $completion) : $super.t2l.call(this, min, $completion);
}
...
class ByteChannel {
  constructor(autoFlush) {
    ...
    this.o2k_1 = autoFlush;
    this.p2k_1 = new Buffer();
    this.q2k_1 = 0;
    this.r2k_1 = new Object();
    this.s2k_1 = atomic$ref$1(Empty_instance);
    this.t2k_1 = new Buffer();
    this.u2k_1 = new Buffer();
    this.v2k_1 = atomic$ref$1(null);
    this.w2k_1 = atomic$ref$1(null);
  }
  y2k() {
    return this.o2k_1;
  }
  z2k() {
    return this.q2k_1 < 1048576;
  }
  a2l() {
    var tmp0_safe_receiver = this.v2k_1.kotlinx$atomicfu$value;
    if (tmp0_safe_receiver == null)
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(tmp0_safe_receiver).g1z();
        } else {
          if (tmp0_subject instanceof CancellationException) {
            ...
            tmp = ClosedReadChannelException.f2l(p0);
          }
        }
      }
    ...
    if (this.m2l()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        if (tmp0_subject == null) {
          ...
          if (isInterface(tmp0_subject, CopyableThrowable)) {
            tmp_0 = access$_get_origin__hdh1qz(tmp0_safe_receiver).g1z();
          } else {
            if (tmp0_subject instanceof CancellationException) {
              ...
              var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
              tmp_0 = ClosedWriteChannelException.l2l(p0);
            }
          }
        }
      ...
      if (tmp == null)
        throw ClosedWriteChannelException.l2l();
    }
    return this.u2k_1;
  }
  n2l() {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          ...
          if (tmp0_subject instanceof CancellationException) {
            ...
            var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
            tmp_0 = ClosedByteChannelException.r2l(p0);
          }
        }
      }
      tmp = tmp_0;
  ...
  m2l() {
    return !(this.v2k_1.kotlinx$atomicfu$value == null);
  }
  s2l() {
    return !(this.n2l() == null) || (this.m2l() && this.q2k_1 === 0 && this.t2k_1.w2g());
  }
  *t2l(min, $completion) {
    rethrowCloseCauseIfNeeded_0(this);
    if (this.t2k_1.m2() >= fromInt(min))
      return true;
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (add(numberToLong(this.q2k_1), this.t2k_1.m2()) < fromInt(min) && this.v2k_1.kotlinx$atomicfu$value == null) {
      ...
      (yield () => {
        ...
        $l$block_0: {
          ...
          var previous = tmp0.s2k_1.kotlinx$atomicfu$value;
          if (!(previous instanceof Closed)) {
            if (!tmp0.s2k_1.atomicfu$compareAndSet(previous, tmp2)) {
              tmp2.i2k();
              break $l$block_0;
            }
          }
          if (previous instanceof Read) {
            previous.j2k(ConcurrentIOException.y2l(tmp2.h2k(), previous.f2k()));
          } else {
            if (isInterface(previous, Task)) {
              previous.i2k();
            } else {
              if (previous instanceof Closed) {
                tmp2.j2k(previous.e2k_1);
                break $l$block_0;
              } else {
          ...
          if (!(add(numberToLong(this.q2k_1), this.t2k_1.m2()) < fromInt(min) && this.v2k_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.s2k_1.kotlinx$atomicfu$value;
            var tmp;
            if (current instanceof Read) {
              tmp = tmp0.s2k_1.atomicfu$compareAndSet(current, Empty_instance);
            } else {
              tmp = false;
            }
            if (tmp) {
        ...
        return cancellable.i1x();
      });
    }
    if (this.t2k_1.m2() < 1048576n) {
      moveFlushToReadBuffer(this);
    }
    return this.t2k_1.m2() >= fromInt(min);
  }
  *a2m($completion) {
    rethrowCloseCauseIfNeeded_0(this);
    this.b2m();
    ...
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (!this.z2k() && this.v2k_1.kotlinx$atomicfu$value == null) {
      // Inline function 'kotlinx.coroutines.suspendCancellableCoroutine' call
      // Inline function 'kotlin.js.suspendCoroutineUninterceptedOrReturnJS' call
      (yield () => {
        var uCont = $completion;
        ...
        $l$block_0: {
          ...
          if (!(!this.z2k() && this.v2k_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.s2k_1.kotlinx$atomicfu$value;
            var tmp;
  ...
  b2m() {
    ...
    this.r2k_1;
    var count = convertToInt(this.u2k_1.m2());
    this.p2k_1.o2i(this.u2k_1);
    this.q2k_1 = this.q2k_1 + count | 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = this.s2k_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Read) {
      tmp = this.s2k_1.atomicfu$compareAndSet(current, Empty_instance);
    } else {
      tmp = false;
    }
    if (tmp) {
  ...
  w5() {
    this.b2m();
    if (!this.v2k_1.atomicfu$compareAndSet(null, get_CLOSED()))
      return Unit_instance;
    closeSlot(this, null);
  }
  *c2m($completion) {
  ...
  d2m(cause) {
    if (!(this.v2k_1.kotlinx$atomicfu$value == null))
      return Unit_instance;
    var closedToken = new CloseToken(cause);
    this.v2k_1.atomicfu$compareAndSet(null, closedToken);
    // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
    ...
    if (tmp0_subject == null) {
      ...
      if (isInterface(tmp0_subject, CopyableThrowable)) {
        tmp = access$_get_origin__hdh1qz(closedToken).g1z();
      } else {
        if (tmp0_subject instanceof CancellationException) {
          ...
          tmp = ClosedByteChannelException.r2l(p0);
        }
      }
    }
  ...
  e2m(handler) {
    var existingCause = this.v2k_1.kotlinx$atomicfu$value;
    if (!(existingCause == null)) {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(existingCause).g1z();
        } else {
          if (tmp0_subject instanceof CancellationException) {
    ...
    if (!this.w2k_1.atomicfu$compareAndSet(null, handler)) {
    ...
    var cause = this.v2k_1.kotlinx$atomicfu$value;
    if (!(cause == null) && this.w2k_1.atomicfu$compareAndSet(handler, null)) {
      // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
      ...
      if (tmp0_subject_0 == null) {
        ...
        if (isInterface(tmp0_subject_0, CopyableThrowable)) {
          tmp_1 = access$_get_origin__hdh1qz(cause).g1z();
        } else {
          if (tmp0_subject_0 instanceof CancellationException) {
            ...
            tmp_1 = ClosedByteChannelException.r2l(p0_0);
          }
        }
      }
      handler(tmp_1);
...
class ConcurrentIOException extends IllegalStateException {
  constructor(taskName, cause) {
    return new.target.y2l(taskName, cause);
  }
  static y2l(taskName, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.q('Concurrent ' + taskName + ' attempts', cause);
    captureStack($this, $this.x2l_1);
    return $this;
  }
}
class ByteChannelScanner {
  constructor(channel, matchString, writeChannel, limit) {
    ...
    this.f2m_1 = channel;
    this.g2m_1 = matchString;
    this.h2m_1 = writeChannel;
    this.i2m_1 = limit;
    ...
    this.j2m_1 = this.f2m_1.a2l();
    this.k2m_1 = buildPartialMatchTable(this);
    this.l2m_1 = new Buffer();
    this.m2m_1 = 0n;
    this.n2m_1 = 0;
  }
  *o2m(ignoreMissing, $completion) {
    this.m2m_1 = 0n;
    while (!this.j2m_1.w2g() || (yield* this.f2m_1.z2l(VOID, $completion))) {
    ...
    if (!ignoreMissing) {
      throw IOException.z2j('Expected "' + toSingleLineString(this, this.g2m_1) + '" but encountered end of input');
    }
    this.m2m_1 = add(this.m2m_1, this.l2m_1.z2h(this.h2m_1.g2l()));
    yield* this.h2m_1.a2m($completion);
    return this.m2m_1;
  }
}
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.t2m_1 = new ByteReadChannel$Companion$Empty$1();
  }
}
class WriterJob {
...
class NO_CALLBACK$1 {
  constructor() {
    this.b2n_1 = EmptyCoroutineContext_instance;
  }
  ub() {
    return this.b2n_1;
  }
...
class CountedByteReadChannel {
  ...
  n2l() {
    return this.d2n_1.n2l();
  }
  s2l() {
    return this.e2n_1.w2g() && this.d2n_1.s2l();
  }
  a2l() {
  ...
  *t2l(min, $completion) {
    if (this.a2l().m2() >= fromInt(min)) {
      return true;
    }
    if (yield* this.d2n_1.t2l(min, $completion)) {
      transferFromDelegate(this);
      return true;
    }
    return false;
...
class ClosedByteChannelException extends IOException {
  ...
  static r2l(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.a2k(cause == null ? null : cause.message, cause);
...
class ClosedReadChannelException extends ClosedByteChannelException {
  constructor(cause) {
    return new.target.f2l(cause);
  }
  static f2l(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.r2l(cause);
...
class Companion_2 {
  constructor() {
    ...
    this.i2n_1 = _LineEndingMode___init__impl__jo5bul(1);
    this.j2n_1 = _LineEndingMode___init__impl__jo5bul(2);
    this.k2n_1 = _LineEndingMode___init__impl__jo5bul(4);
    this.l2n_1 = _LineEndingMode___init__impl__jo5bul(7);
    this.m2n_1 = listOf([new LineEndingMode(this.i2n_1), new LineEndingMode(this.j2n_1), new LineEndingMode(this.k2n_1)]);
  }
}
class LineEndingMode {
  ...
  toString() {
    return LineEndingMode__toString_impl_j4h76r(this.n2n_1);
  }
  hashCode() {
    return LineEndingMode__hashCode_impl_2mopm4(this.n2n_1);
  }
  equals(other) {
    return LineEndingMode__equals_impl_qyr4nk(this.n2n_1, other);
  }
}
class SourceByteReadChannel {
  ...
  n2l() {
    var tmp0_safe_receiver = this.p2n_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  *t2l(min, $completion) {
    ...
    return this.o2n_1.y2g(fromInt(min));
  }
  d2m(cause) {
    if (!(this.p2n_1 == null))
      return Unit_instance;
    ...
    tmp.p2n_1 = new CloseToken(IOException.a2k(tmp1_elvis_lhs == null ? 'Channel was cancelled' : tmp1_elvis_lhs, cause));
  }
}
class MalformedInputException extends IOException {
  constructor(message) {
    return new.target.t2n(message);
  }
  static t2n(message) {
    var $this = this.z2j(message);
    captureStack($this, $this.s2n_1);
    return $this;
  }
}
class TooLongLineException extends MalformedInputException {
  constructor(message) {
    return new.target.y2m(message);
  }
  static y2m(message) {
    var $this = this.t2n(message);
    captureStack($this, $this.x2m_1);
    return $this;
  }
}
class ObjectPool {}
...
class DefaultPool {
  ...
  j2o() {
    if (this.f2o_1 === 0)
      return this.c2o();
    this.f2o_1 = this.f2o_1 - 1 | 0;
    var idx = this.f2o_1;
    var tmp = this.e2o_1[idx];
    var instance = !(tmp == null) ? tmp : THROW_CCE();
    this.e2o_1[idx] = null;
    return this.h2o(instance);
  }
  k2o(instance) {
    this.i2o(instance);
    if (this.f2o_1 === this.d2o_1) {
      this.g2o(instance);
    } else {
      var _unary__edvuaz = this.f2o_1;
      this.f2o_1 = _unary__edvuaz + 1 | 0;
      this.e2o_1[_unary__edvuaz] = instance;
    }
  }
  t1v() {
...
class Companion_3 {
  l2o(name) {
    switch (name) {
      ...
      case 'UTF8':
      case 'utf8':
        return Charsets_getInstance().u2n_1;
    }
    var tmp;
    var tmp_0;
    switch (name) {
    ...
    if (tmp) {
      return Charsets_getInstance().v2n_1;
    }
...
class Charsets {
  constructor() {
    ...
    this.u2n_1 = new CharsetImpl('UTF-8');
    this.v2n_1 = new CharsetImpl('ISO-8859-1');
  }
}
...
class CharsetEncoderImpl extends CharsetEncoder {
  ...
  toString() {
    return 'CharsetEncoderImpl(charset=' + this.r2o_1.toString() + ')';
  }
  hashCode() {
    return this.r2o_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof CharsetEncoderImpl))
      return false;
    if (!this.r2o_1.equals(other.r2o_1))
      return false;
    return true;
  }
}
class CharsetDecoderImpl extends CharsetDecoder {
  ...
  toString() {
    return 'CharsetDecoderImpl(charset=' + this.t2o_1.toString() + ')';
  }
  hashCode() {
    return this.t2o_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof CharsetDecoderImpl))
      return false;
    if (!this.t2o_1.equals(other.t2o_1))
      return false;
    return true;
  }
}
class toKtor$1 {
  constructor($this_toKtor) {
    this.u2o_1 = $this_toKtor;
  }
  o2o(buffer) {
    return this.u2o_1.decode(buffer);
  }
}
  ...
  o2o(buffer) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        if (point > 255) {
          builder.p2i(toByte(point >> 8));
        }
        builder.p2i(toByte(point & 255));
      }
       while (inductionVariable < last);
...
function closeSlot($this, cause) {
  var closeContinuation = !(cause == null) ? new Closed(cause) : Companion_getInstance().c2k_1;
  var continuation = $this.s2k_1.atomicfu$getAndSet(closeContinuation);
  if (isInterface(continuation, Task)) {
    continuation.j2k(cause);
  }
  var tmp0_safe_receiver = $this.w2k_1.atomicfu$getAndSet(null);
  if (tmp0_safe_receiver == null)
    null;
  else
...
function ByteChannel$invokeOnClose$lambda_1(this$0, $handler) {
  return () => {
    this$0.w2k_1.atomicfu$compareAndSet($handler, null);
    return Unit_instance;
  };
}
function ByteReadChannel_0(content, offset, length) {
  ...
  this_0.f2i(content, offset, offset + length | 0);
  var source = this_0;
...
function buildPartialMatchTable($this) {
  var table = new Int32Array($this.g2m_1.m2());
  var j = 0;
  var inductionVariable = 1;
  var last = $this.g2m_1.m2();
  if (inductionVariable < last)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      while (j > 0 && !($this.g2m_1.k2(i) === $this.g2m_1.k2(j))) {
        j = table[j - 1 | 0];
      }
      if ($this.g2m_1.k2(i) === $this.g2m_1.k2(j)) {
        j = j + 1 | 0;
      }
      table[i] = j;
    }
...
function *advanceToNextPotentialMatch($this, $completion) {
  while (!$this.j2m_1.w2g() || (yield* $this.f2m_1.z2l(VOID, $completion))) {
    var nextMatch = indexOf($this.j2m_1, $this.g2m_1.k2(0));
    if (nextMatch === -1n) {
      var tmp = $this.j2m_1;
      checkBounds($this, (tmp instanceof Buffer ? tmp : THROW_CCE()).m2());
      $this.m2m_1 = add($this.m2m_1, $this.j2m_1.z2h($this.h2m_1.g2l()));
      yield* flushIfNeeded($this.h2m_1, $completion);
    } else {
      checkBounds($this, nextMatch);
      var tmp_0 = $this;
      var tmp_1 = $this.m2m_1;
      var tmp_2 = $this.h2m_1.g2l();
      tmp_0.m2m_1 = add(tmp_1, $this.j2m_1.w2h(tmp_2 instanceof Buffer ? tmp_2 : THROW_CCE(), nextMatch));
      yield* flushIfNeeded($this.h2m_1, $completion);
      return Unit_instance;
    }
  }
...
function *checkFullMatch($this, $completion) {
  while (!$this.j2m_1.w2g() || (yield* $this.f2m_1.z2l(VOID, $completion))) {
    var byte = $this.j2m_1.z2g();
    if ($this.n2m_1 > 0 && !(byte === $this.g2m_1.k2($this.n2m_1))) {
      var oldMatchIndex = $this.n2m_1;
      while ($this.n2m_1 > 0 && !(byte === $this.g2m_1.k2($this.n2m_1))) {
        $this.n2m_1 = $this.k2m_1[$this.n2m_1 - 1 | 0];
      }
      var retained = fromInt(oldMatchIndex - $this.n2m_1 | 0);
      checkBounds($this, retained);
      var tmp = $this;
      var tmp_0 = $this.m2m_1;
      var tmp_1 = $this.h2m_1.g2l();
      tmp.m2m_1 = add(tmp_0, $this.l2m_1.w2h(tmp_1 instanceof Buffer ? tmp_1 : THROW_CCE(), retained));
      if ($this.n2m_1 === 0 && !(byte === $this.g2m_1.k2($this.n2m_1))) {
        yield* writeByte($this.h2m_1, byte, $completion);
        var _unary__edvuaz = $this.m2m_1;
        $this.m2m_1 = add(_unary__edvuaz, get_ONE());
        return false;
      }
    }
    $this.n2m_1 = $this.n2m_1 + 1 | 0;
    if ($this.n2m_1 === $this.g2m_1.m2()) {
      return true;
    }
    $this.l2m_1.p2i(byte);
  }
...
function checkBounds($this, extra) {
  if (add($this.m2m_1, extra) > $this.i2m_1) {
    throw IOException.z2j('Limit of ' + $this.i2m_1.toString() + ' bytes exceeded ' + ('while searching for "' + toSingleLineString($this, $this.g2m_1) + '"'));
  }
}
...
function attachWriterJob(_this__u8e3s4, writerJob) {
  var tmp = writerJob.p2m_1;
  var tmp0_safe_receiver = tmp instanceof ByteChannel ? tmp : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.e2m(attachWriterJob$lambda(_this__u8e3s4));
  }
}
function attachWriterJob$lambda($this_attachWriterJob) {
  return (cause) => {
    var tmp;
    if (!(cause == null)) {
      $this_attachWriterJob.d2m(cause);
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function cancel_0(_this__u8e3s4) {
  _this__u8e3s4.d2m(IOException.z2j('Channel was cancelled'));
}
function *readRemaining(_this__u8e3s4, $completion) {
  var result = BytePacketBuilder();
  while (!_this__u8e3s4.s2l()) {
    result.o2i(_this__u8e3s4.a2l());
    yield* _this__u8e3s4.z2l(VOID, $completion);
  }
...
function *copyTo(_this__u8e3s4, channel, limit, $completion) {
  var remaining = limit;
  try {
    while (!_this__u8e3s4.s2l() && remaining > 0n) {
      if (_this__u8e3s4.a2l().w2g()) {
        yield* _this__u8e3s4.z2l(VOID, $completion);
      }
      var tmp0 = remaining;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = get_remaining(_this__u8e3s4.a2l());
      var count = tmp0 <= b ? tmp0 : b;
      _this__u8e3s4.a2l().y2h(channel.g2l(), count);
      remaining = subtract(remaining, count);
      yield* channel.a2m($completion);
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var cause = $p;
      _this__u8e3s4.d2m(cause);
...
function *discard(_this__u8e3s4, max, $completion) {
  ...
  var remaining = max;
  while (remaining > 0n && !_this__u8e3s4.s2l()) {
    ...
    var b = get_remaining(_this__u8e3s4.a2l());
    var count = tmp0 <= b ? tmp0 : b;
    discard_0(_this__u8e3s4.a2l(), count);
    remaining = subtract(remaining, count);
  }
...
function *copyTo_0(_this__u8e3s4, channel, $completion) {
  ...
  try {
    while (!_this__u8e3s4.s2l()) {
      result = add(result, _this__u8e3s4.a2l().z2h(channel.g2l()));
      yield* channel.a2m($completion);
      yield* _this__u8e3s4.z2l(VOID, $completion);
    }
  } catch ($p) {
...
function *readAvailable(_this__u8e3s4, buffer, offset, length, $completion) {
  ...
  if (_this__u8e3s4.s2l())
    return -1;
  return readAvailable_0(_this__u8e3s4.a2l(), buffer, offset, length);
}
...
function *readPacket(_this__u8e3s4, packet, $completion) {
  ...
  $l$loop: while (result.m2() < fromInt(packet)) {
    ...
    if (_this__u8e3s4.s2l())
      break $l$loop;
    if (get_remaining(_this__u8e3s4.a2l()) > subtract(numberToLong(packet), result.m2())) {
      _this__u8e3s4.a2l().y2h(result, subtract(numberToLong(packet), result.m2()));
    } else {
      _this__u8e3s4.a2l().z2h(result);
    }
  }
  if (result.m2() < fromInt(packet)) {
    throw EOFException.u2g('Not enough data available, required ' + packet + ' bytes but only ' + result.m2().toString() + ' available');
  }
  return result;
}
function *readUntil(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion) {
  ...
  return yield* (new ByteChannelScanner(_this__u8e3s4, matchString, writeChannel, limit)).o2m(ignoreMissing, $completion);
}
...
function get_availableForRead(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.a2l().v2g().m2());
}
function *peek(_this__u8e3s4, count, $completion) {
  if (_this__u8e3s4.s2l())
    return null;
  if (!(yield* _this__u8e3s4.t2l(count, $completion)))
    return null;
  return readByteString(_this__u8e3s4.a2l().a2i(), count);
}
function *internalReadLineTo(_this__u8e3s4, out, limit, lenientLineEnding, throwOnIncompleteLine, $completion) {
  var readBuffer = _this__u8e3s4.a2l();
  if (readBuffer.w2g()) {
    yield* _this__u8e3s4.z2l(VOID, $completion);
  }
  if (_this__u8e3s4.s2l())
    return -1n;
  var consumed = {_v: 0n};
  $l$loop: while (consumed._v < limit && !_this__u8e3s4.s2l()) {
    ...
    if (lfIndex > 0n) {
      var tmp;
      var tmp_0 = readBuffer.v2g();
      // Inline function 'kotlin.Long.minus' call
      var tmp$ret$0 = subtract(lfIndex, fromInt(1));
      if (tmp_0.r2h(tmp$ret$0) === 13) {
        tmp = 1n;
      } else {
        tmp = 0n;
      }
    ...
    var tmp_1 = readBuffer.v2g();
    // Inline function 'kotlin.Long.minus' call
    var tmp$ret$2 = subtract(count, fromInt(1));
    if (tmp_1.r2h(tmp$ret$2) === 13) {
      // Inline function 'kotlin.Long.minus' call
    ...
    if (consumed._v < limit && get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.z2l(VOID, $completion)))
      break $l$loop;
  }
  if (consumed._v === 0n && _this__u8e3s4.s2l())
    return -1n;
  // Inline function 'kotlin.check' call
  ...
  if (consumed._v === limit) {
    if (limit === 9223372036854775807n)
      throw TooLongLineException.y2m('Max line length exceeded');
    if (get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.z2l(VOID, $completion))) {
      throwEndOfStreamException(consumed._v);
    }
    var tmp0_subject = readBuffer.v2g().r2h(0n);
    if (tmp0_subject === 10) {
      discard_0(readBuffer, 1n);
      return consumed._v;
...
function throwEndOfStreamException(consumed) {
  throw EOFException.u2g('Unexpected end of stream after reading ' + consumed.toString() + ' characters');
}
function throwTooLongLineException(limit) {
  throw TooLongLineException.y2m('Line exceeds limit of ' + limit.toString() + ' characters');
}
...
function *internalReadLineTo$discardCrlfOrCr(_this__u8e3s4, $this_internalReadLineTo, $lenientLineEnding, $completion) {
  if ((get_remaining(_this__u8e3s4) >= 2n || (yield* $this_internalReadLineTo.t2l(2, $completion))) && _this__u8e3s4.v2g().r2h(1n) === 10) {
...
function *flushIfNeeded(_this__u8e3s4, $completion) {
  ...
  if (_this__u8e3s4.y2k() || get_size(_this__u8e3s4.g2l()) >= 1048576)
...
function ByteWriteChannel$flushAndClose$ref(p0) {
  return constructCallableReference(function *($completion) {
    return yield* p0.c2m($completion);
...
function invokeOnCompletion(_this__u8e3s4, block) {
  _init_properties_ByteWriteChannelOperations_kt__i7slrs();
  return _this__u8e3s4.j1y().s1t(block);
}
function *writeFully(_this__u8e3s4, value, startIndex, endIndex, $completion) {
  startIndex = startIndex === VOID ? 0 : startIndex;
  endIndex = endIndex === VOID ? value.length : endIndex;
  _this__u8e3s4.g2l().f2i(value, startIndex, endIndex);
...
function *writePacket(_this__u8e3s4, source, $completion) {
  while (!source.w2g()) {
    _this__u8e3s4.g2l().j2i(source, get_remaining(source));
    yield* flushIfNeeded(_this__u8e3s4, $completion);
  }
  return Unit_instance;
}
function writer_0(_this__u8e3s4, coroutineContext, channel, block) {
  ...
  this_0.s1t(writer$lambda(channel));
  var job = this_0;
...
function *writeByte(_this__u8e3s4, value, $completion) {
  _this__u8e3s4.g2l().p2i(value);
  yield* flushIfNeeded(_this__u8e3s4, $completion);
  return Unit_instance;
}
function writer$slambda($block, $channel) {
  return constructCallableReference(function *($this$launch, $completion) {
    var nested = Job(get_job($this$launch.q1s()));
    var tmp;
    try {
      yield* $block(new WriterScope($channel, $this$launch.q1s().fm(nested)), $completion);
      nested.v1y();
      var tmp_0;
      if (get_job($this$launch.q1s()).m1t()) {
        $channel.d2m(get_job($this$launch.q1s()).p1t());
        tmp_0 = Unit_instance;
      }
      tmp = tmp_0;
    } catch ($p) {
      ...
      yield* nested.w1t($completion);
      // Inline function 'kotlin.runCatching' call
      var tmp_2;
      try {
        yield* $channel.c2m($completion);
        // Inline function 'kotlin.Companion.success' call
...
function transferFromDelegate($this) {
  updateConsumed($this);
  var appended = $this.e2n_1.o2i($this.d2n_1.a2l());
  $this.f2n_1 = add($this.f2n_1, appended);
}
function updateConsumed($this) {
  $this.g2n_1 = add($this.g2n_1, subtract($this.f2n_1, $this.e2n_1.m2()));
  $this.f2n_1 = $this.e2n_1.m2();
}
...
function LineEndingMode__toString_impl_j4h76r($this) {
  var tmp;
  if ($this === Companion_getInstance_2().i2n_1) {
    tmp = 'CR';
  } else if ($this === Companion_getInstance_2().j2n_1) {
    tmp = 'LF';
  } else if ($this === Companion_getInstance_2().k2n_1) {
    tmp = 'CRLF';
  } else {
    // Inline function 'kotlin.collections.filter' call
    var tmp0 = Companion_getInstance_2().m2n_1;
    // Inline function 'kotlin.collections.filterTo' call
    var destination = ArrayList.l2();
    var _iterator__ex2g4s = tmp0.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var it = element.n2n_1;
...
function writeFully_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  _this__u8e3s4.f2i(buffer, offset, offset + length | 0);
}
function build(_this__u8e3s4) {
  return _this__u8e3s4.v2g();
}
function get_size(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.v2g().m2());
}
...
function ByteReadPacket(array, offset, length) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = new Buffer();
  this_0.f2i(array, offset, offset + length | 0);
  return this_0;
}
function get_remaining(_this__u8e3s4) {
  _init_properties_ByteReadPacket_kt__28475y();
  return _this__u8e3s4.v2g().m2();
}
function takeWhile(_this__u8e3s4, block) {
  _init_properties_ByteReadPacket_kt__28475y();
  while (!_this__u8e3s4.w2g() && block(_this__u8e3s4.v2g())) {
  }
}
function discard_0(_this__u8e3s4, count) {
  count = count === VOID ? 9223372036854775807n : count;
  _init_properties_ByteReadPacket_kt__28475y();
  _this__u8e3s4.y2g(count);
  // Inline function 'kotlin.comparisons.minOf' call
  var b = get_remaining(_this__u8e3s4);
  var countToDiscard = count <= b ? count : b;
  _this__u8e3s4.v2g().t2h(countToDiscard);
...
function readAvailable_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  var result = _this__u8e3s4.u2h(buffer, offset, offset + length | 0);
  return result === -1 ? 0 : result;
}
function toByteArray_0(_this__u8e3s4, charset) {
  charset = charset === VOID ? Charsets_getInstance().u2n_1 : charset;
  if (charset.equals(Charsets_getInstance().u2n_1))
    return encodeToByteArray(_this__u8e3s4, VOID, VOID, true);
  return encodeToByteArray_0(charset.x2n(), _this__u8e3s4, 0, _this__u8e3s4.length);
}
function readText_0(_this__u8e3s4, charset, max) {
  ...
  if (charset.equals(Charsets_getInstance().u2n_1)) {
    if (max === 2147483647)
      return readString_0(_this__u8e3s4);
    var tmp0 = _this__u8e3s4.v2g().m2();
    // Inline function 'kotlin.math.min' call
    var b = fromInt(max);
    var count = tmp0 <= b ? tmp0 : b;
    return readString(_this__u8e3s4, count);
  }
  return decode(charset.y2n(), _this__u8e3s4, max);
}
function writeText(_this__u8e3s4, text, fromIndex, toIndex, charset) {
  fromIndex = fromIndex === VOID ? 0 : fromIndex;
  toIndex = toIndex === VOID ? charSequenceLength(text) : toIndex;
  charset = charset === VOID ? Charsets_getInstance().u2n_1 : charset;
  if (charset === Charsets_getInstance().u2n_1) {
    return writeString(_this__u8e3s4, toString_1(text), fromIndex, toIndex);
  }
  encodeToImpl(charset.x2n(), _this__u8e3s4, text, fromIndex, toIndex);
}
...
function forName(_this__u8e3s4, name) {
  return Companion_instance_4.l2o(name);
}
function decode_0(_this__u8e3s4, input, dst, max) {
  var decoder = Decoder(get_name(get_charset(_this__u8e3s4)), true);
  var tmp0 = input.v2g().m2();
  // Inline function 'kotlin.comparisons.minOf' call
  var b = fromInt(max);
  var count = tmp0 <= b ? tmp0 : b;
  ...
  try {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    tmp = decoder.o2o(array);
  } catch ($p) {
    var tmp_0;
    if ($p instanceof Error) {
      var cause = $p;
      var tmp0_elvis_lhs = cause.message;
      throw MalformedInputException.t2n('Failed to decode bytes: ' + (tmp0_elvis_lhs == null ? 'no cause provided' : tmp0_elvis_lhs));
    } else {
      throw $p;
    }
  }
...
function encodeImpl(_this__u8e3s4, input, fromIndex, toIndex, dst) {
  ...
  if (get_charset_0(_this__u8e3s4).equals(Charsets_getInstance().v2n_1)) {
    return encodeISO88591(input, fromIndex, toIndex, dst);
  }
  // Inline function 'kotlin.require' call
  if (!(get_charset_0(_this__u8e3s4) === Charsets_getInstance().u2n_1)) {
...
function ioDispatcher() {
  return Dispatchers_getInstance().e23_1;
}
function encodeISO88591(input, fromIndex, toIndex, dst) {
  ...
  if (inductionVariable < toIndex)
    do {
      ...
      dst.p2i(toByte(character));
    }
     while (inductionVariable < toIndex);
  return toIndex - fromIndex | 0;
}
function failedToMapError(ch) {
  throw MalformedInputException.t2n('The character with unicode point ' + ch + " couldn't be mapped to ISO-8859-1 character");
}
...
protoOf(Read).i2k = resume;
protoOf(Read).j2k = resume_0;
initMetadataForClass(Read, 'Read', VOID, VOID, [Task]);
protoOf(Write).i2k = resume;
protoOf(Write).j2k = resume_0;
...
protoOf(ByteChannel).z2l = awaitContent$default;
...
protoOf(ByteReadChannel$Companion$Empty$1).z2l = awaitContent$default;
...
protoOf(CountedByteReadChannel).z2l = awaitContent$default;
initMetadataForClass(CountedByteReadChannel, 'CountedByteReadChannel', VOID, VOID, [ByteReadChannel], [1]);
initMetadataForClass(ClosedByteChannelException, 'ClosedByteChannelException', ClosedByteChannelException.r2l);
initMetadataForClass(ClosedReadChannelException, 'ClosedReadChannelException', ClosedReadChannelException.f2l);
initMetadataForClass(ClosedWriteChannelException, 'ClosedWriteChannelException', ClosedWriteChannelException.l2l);
initMetadataForClass(LineEnding, 'LineEnding');
initMetadataForCompanion(Companion_2);
initMetadataForClass(LineEndingMode, 'LineEndingMode');
protoOf(SourceByteReadChannel).z2l = awaitContent$default;
...
protoOf(DefaultPool).w5 = close;
initMetadataForClass(DefaultPool, 'DefaultPool', VOID, VOID, [ObjectPool]);
initMetadataForClass(ByteArrayPool$1);
protoOf(NoPoolImpl).w5 = close;
