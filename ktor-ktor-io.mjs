...
class Companion {
  constructor() {
    ...
    this.g2l_1 = new Closed(null);
    var tmp = this;
    // Inline function 'kotlin.Companion.success' call
    tmp.h2l_1 = _Result___init__impl__xyqfz8(Unit_instance);
  }
}
class Empty {
  toString() {
...
class Closed {
  ...
  toString() {
    return 'Closed(cause=' + toString(this.i2l_1) + ')';
  }
  hashCode() {
    return this.i2l_1 == null ? 0 : hashCode(this.i2l_1);
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof Closed))
      return false;
    if (!equals(this.i2l_1, other.i2l_1))
      return false;
    return true;
  }
}
class Task {}
function resume() {
  return this.k2l().hc(Companion_getInstance().h2l_1);
}
function resume_0(throwable) {
  ...
  return tmp.hc(tmp1_elvis_lhs == null ? Companion_getInstance().h2l_1 : tmp1_elvis_lhs.ot_1);
}
class Read {
  constructor(continuation) {
    this.o2l_1 = continuation;
    this.p2l_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('ReadTask 0x' + toString_0(hashCode(this.o2l_1), 16));
...
class Write {
  constructor(continuation) {
    this.q2l_1 = continuation;
    this.r2l_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('WriteTask 0x' + toString_0(hashCode(this.q2l_1), 16));
      stackTraceToString(this_0);
      tmp.r2l_1 = this_0;
    }
  }
...
function awaitContent$default(min, $completion, $super) {
  min = min === VOID ? 1 : min;
  return $super === VOID ? this.x2m(min, $completion) : $super.x2m.call(this, min, $completion);
}
...
class ByteChannel {
  constructor(autoFlush) {
    ...
    this.s2l_1 = autoFlush;
    this.t2l_1 = new Buffer();
    this.u2l_1 = 0;
    this.v2l_1 = new Object();
    this.w2l_1 = atomic$ref$1(Empty_instance);
    this.x2l_1 = new Buffer();
    this.y2l_1 = new Buffer();
    this.z2l_1 = atomic$ref$1(null);
    this.a2m_1 = atomic$ref$1(null);
  }
  c2m() {
    return this.s2l_1;
  }
  d2m() {
    return this.u2l_1 < 1048576;
  }
  e2m() {
    var tmp0_safe_receiver = this.z2l_1.kotlinx$atomicfu$value;
    if (tmp0_safe_receiver == null)
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(tmp0_safe_receiver).f13();
        } else {
          if (tmp0_subject instanceof CancellationException) {
            ...
            tmp = ClosedReadChannelException.j2m(p0);
          }
        }
      }
    ...
    if (this.q2m()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        if (tmp0_subject == null) {
          ...
          if (isInterface(tmp0_subject, CopyableThrowable)) {
            tmp_0 = access$_get_origin__hdh1qz(tmp0_safe_receiver).f13();
          } else {
            if (tmp0_subject instanceof CancellationException) {
              ...
              var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
              tmp_0 = ClosedWriteChannelException.p2m(p0);
            }
          }
        }
      ...
      if (tmp == null)
        throw ClosedWriteChannelException.p2m();
    }
    return this.y2l_1;
  }
  r2m() {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          ...
          if (tmp0_subject instanceof CancellationException) {
            ...
            var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
            tmp_0 = ClosedByteChannelException.v2m(p0);
          }
        }
      }
      tmp = tmp_0;
  ...
  q2m() {
    return !(this.z2l_1.kotlinx$atomicfu$value == null);
  }
  w2m() {
    return !(this.r2m() == null) || (this.q2m() && this.u2l_1 === 0 && this.x2l_1.a2i());
  }
  *x2m(min, $completion) {
    rethrowCloseCauseIfNeeded_0(this);
    if (this.x2l_1.m2() >= fromInt(min))
      return true;
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (add(numberToLong(this.u2l_1), this.x2l_1.m2()) < fromInt(min) && this.z2l_1.kotlinx$atomicfu$value == null) {
      ...
      (yield () => {
        ...
        $l$block_0: {
          ...
          var previous = tmp0.w2l_1.kotlinx$atomicfu$value;
          if (!(previous instanceof Closed)) {
            if (!tmp0.w2l_1.atomicfu$compareAndSet(previous, tmp2)) {
              tmp2.m2l();
              break $l$block_0;
            }
          }
          if (previous instanceof Read) {
            previous.n2l(ConcurrentIOException.c2n(tmp2.l2l(), previous.j2l()));
          } else {
            if (isInterface(previous, Task)) {
              previous.m2l();
            } else {
              if (previous instanceof Closed) {
                tmp2.n2l(previous.i2l_1);
                break $l$block_0;
              } else {
          ...
          if (!(add(numberToLong(this.u2l_1), this.x2l_1.m2()) < fromInt(min) && this.z2l_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.w2l_1.kotlinx$atomicfu$value;
            var tmp;
            if (current instanceof Read) {
              tmp = tmp0.w2l_1.atomicfu$compareAndSet(current, Empty_instance);
            } else {
              tmp = false;
            }
            if (tmp) {
        ...
        return cancellable.ky();
      });
    }
    if (this.x2l_1.m2() < 1048576n) {
      moveFlushToReadBuffer(this);
    }
    return this.x2l_1.m2() >= fromInt(min);
  }
  *e2n($completion) {
    rethrowCloseCauseIfNeeded_0(this);
    this.f2n();
    ...
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (!this.d2m() && this.z2l_1.kotlinx$atomicfu$value == null) {
      // Inline function 'kotlinx.coroutines.suspendCancellableCoroutine' call
      // Inline function 'kotlin.js.suspendCoroutineUninterceptedOrReturnJS' call
      (yield () => {
        var uCont = $completion;
        ...
        $l$block_0: {
          ...
          if (!(!this.d2m() && this.z2l_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.w2l_1.kotlinx$atomicfu$value;
            var tmp;
  ...
  f2n() {
    ...
    this.v2l_1;
    var count = convertToInt(this.y2l_1.m2());
    this.t2l_1.s2j(this.y2l_1);
    this.u2l_1 = this.u2l_1 + count | 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = this.w2l_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Read) {
      tmp = this.w2l_1.atomicfu$compareAndSet(current, Empty_instance);
    } else {
      tmp = false;
    }
    if (tmp) {
  ...
  y5() {
    this.f2n();
    if (!this.z2l_1.atomicfu$compareAndSet(null, get_CLOSED()))
      return Unit_instance;
    closeSlot(this, null);
  }
  *g2n($completion) {
  ...
  h2n(cause) {
    if (!(this.z2l_1.kotlinx$atomicfu$value == null))
      return Unit_instance;
    var closedToken = new CloseToken(cause);
    this.z2l_1.atomicfu$compareAndSet(null, closedToken);
    // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
    ...
    if (tmp0_subject == null) {
      ...
      if (isInterface(tmp0_subject, CopyableThrowable)) {
        tmp = access$_get_origin__hdh1qz(closedToken).f13();
      } else {
        if (tmp0_subject instanceof CancellationException) {
          ...
          tmp = ClosedByteChannelException.v2m(p0);
        }
      }
    }
  ...
  i2n(handler) {
    var existingCause = this.z2l_1.kotlinx$atomicfu$value;
    if (!(existingCause == null)) {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(existingCause).f13();
        } else {
          if (tmp0_subject instanceof CancellationException) {
    ...
    if (!this.a2m_1.atomicfu$compareAndSet(null, handler)) {
    ...
    var cause = this.z2l_1.kotlinx$atomicfu$value;
    if (!(cause == null) && this.a2m_1.atomicfu$compareAndSet(handler, null)) {
      // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
      ...
      if (tmp0_subject_0 == null) {
        ...
        if (isInterface(tmp0_subject_0, CopyableThrowable)) {
          tmp_1 = access$_get_origin__hdh1qz(cause).f13();
        } else {
          if (tmp0_subject_0 instanceof CancellationException) {
            ...
            tmp_1 = ClosedByteChannelException.v2m(p0_0);
          }
        }
      }
      handler(tmp_1);
...
class ConcurrentIOException extends IllegalStateException {
  constructor(taskName, cause) {
    return new.target.c2n(taskName, cause);
  }
  static c2n(taskName, cause) {
...
class ByteChannelScanner {
  constructor(channel, matchString, writeChannel, limit) {
    ...
    this.j2n_1 = channel;
    this.k2n_1 = matchString;
    this.l2n_1 = writeChannel;
    this.m2n_1 = limit;
    ...
    this.n2n_1 = this.j2n_1.e2m();
    this.o2n_1 = buildPartialMatchTable(this);
    this.p2n_1 = new Buffer();
    this.q2n_1 = 0n;
    this.r2n_1 = 0;
  }
  *s2n(ignoreMissing, $completion) {
    this.q2n_1 = 0n;
    while (!this.n2n_1.a2i() || (yield* this.j2n_1.d2n(VOID, $completion))) {
    ...
    if (!ignoreMissing) {
      throw IOException.d2l('Expected "' + toSingleLineString(this, this.k2n_1) + '" but encountered end of input');
    }
    this.q2n_1 = add(this.q2n_1, this.p2n_1.d2j(this.l2n_1.k2m()));
    yield* this.l2n_1.e2n($completion);
    return this.q2n_1;
  }
}
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.x2n_1 = new ByteReadChannel$Companion$Empty$1();
  }
}
class WriterJob {
...
class NO_CALLBACK$1 {
  constructor() {
    this.f2o_1 = EmptyCoroutineContext_instance;
  }
  fc() {
    return this.f2o_1;
  }
...
class CountedByteReadChannel {
  ...
  r2m() {
    return this.h2o_1.r2m();
  }
  w2m() {
    return this.i2o_1.a2i() && this.h2o_1.w2m();
  }
  e2m() {
  ...
  *x2m(min, $completion) {
    if (this.e2m().m2() >= fromInt(min)) {
      return true;
    }
    if (yield* this.h2o_1.x2m(min, $completion)) {
      transferFromDelegate(this);
      return true;
    }
    return false;
  ...
  h2n(cause) {
    this.h2o_1.h2n(cause);
    this.i2o_1.y5();
  }
}
class ClosedByteChannelException extends IOException {
  constructor(cause) {
    return new.target.v2m(cause);
  }
  static v2m(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.e2l(cause == null ? null : cause.message, cause);
    captureStack($this, $this.u2m_1);
    return $this;
  }
}
class ClosedReadChannelException extends ClosedByteChannelException {
  constructor(cause) {
    return new.target.j2m(cause);
  }
  static j2m(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.v2m(cause);
...
class ClosedWriteChannelException extends ClosedByteChannelException {
  constructor(cause) {
    return new.target.p2m(cause);
  }
  static p2m(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.v2m(cause);
    captureStack($this, $this.o2m_1);
    return $this;
  }
}
...
class Companion_2 {
  constructor() {
    ...
    this.m2o_1 = _LineEndingMode___init__impl__jo5bul(1);
    this.n2o_1 = _LineEndingMode___init__impl__jo5bul(2);
    this.o2o_1 = _LineEndingMode___init__impl__jo5bul(4);
    this.p2o_1 = _LineEndingMode___init__impl__jo5bul(7);
    this.q2o_1 = listOf([new LineEndingMode(this.m2o_1), new LineEndingMode(this.n2o_1), new LineEndingMode(this.o2o_1)]);
  }
}
class LineEndingMode {
  ...
  toString() {
    return LineEndingMode__toString_impl_j4h76r(this.r2o_1);
  }
  hashCode() {
    return LineEndingMode__hashCode_impl_2mopm4(this.r2o_1);
  }
  equals(other) {
    return LineEndingMode__equals_impl_qyr4nk(this.r2o_1, other);
  }
}
class SourceByteReadChannel {
  ...
  w2m() {
    return this.s2o_1.a2i();
  }
  e2m() {
    var tmp0_safe_receiver = this.r2m();
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
  ...
  *x2m(min, $completion) {
    ...
    return this.s2o_1.c2i(fromInt(min));
  }
  h2n(cause) {
    if (!(this.t2o_1 == null))
      return Unit_instance;
    ...
    tmp.t2o_1 = new CloseToken(IOException.e2l(tmp1_elvis_lhs == null ? 'Channel was cancelled' : tmp1_elvis_lhs, cause));
  }
}
class MalformedInputException extends IOException {
  constructor(message) {
    return new.target.x2o(message);
  }
  static x2o(message) {
    var $this = this.d2l(message);
    captureStack($this, $this.w2o_1);
    return $this;
  }
}
class TooLongLineException extends MalformedInputException {
  constructor(message) {
    return new.target.c2o(message);
  }
  static c2o(message) {
    var $this = this.x2o(message);
    captureStack($this, $this.b2o_1);
    return $this;
  }
}
class ObjectPool {}
...
class DefaultPool {
  ...
  n2p() {
    ...
    var idx = this.j2p_1;
    var tmp = this.i2p_1[idx];
    var instance = !(tmp == null) ? tmp : THROW_CCE();
    this.i2p_1[idx] = null;
    return this.l2p(instance);
  }
  o2p(instance) {
    this.m2p(instance);
    if (this.j2p_1 === this.h2p_1) {
      this.k2p(instance);
    } else {
      var _unary__edvuaz = this.j2p_1;
      this.j2p_1 = _unary__edvuaz + 1 | 0;
      this.i2p_1[_unary__edvuaz] = instance;
    }
  }
  tz() {
...
class Companion_3 {
  p2p(name) {
    switch (name) {
      ...
      case 'UTF8':
      case 'utf8':
        return Charsets_getInstance().y2o_1;
    }
    var tmp;
    var tmp_0;
    switch (name) {
    ...
    if (tmp) {
      return Charsets_getInstance().z2o_1;
    }
...
class Charset {
  ...
  equals(other) {
    ...
    if (!(other instanceof Charset))
      THROW_CCE();
    return this.a2p_1 === other.a2p_1;
  }
  hashCode() {
    return getStringHashCode(this.a2p_1);
  }
  toString() {
    return this.a2p_1;
  }
...
class Charsets {
  constructor() {
    ...
    this.y2o_1 = new CharsetImpl('UTF-8');
    this.z2o_1 = new CharsetImpl('ISO-8859-1');
  }
}
...
class CharsetEncoderImpl extends CharsetEncoder {
  ...
  toString() {
    return 'CharsetEncoderImpl(charset=' + this.v2p_1.toString() + ')';
  }
  hashCode() {
    return this.v2p_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
...
class CharsetDecoderImpl extends CharsetDecoder {
  ...
  toString() {
    return 'CharsetDecoderImpl(charset=' + this.x2p_1.toString() + ')';
  }
  hashCode() {
    return this.x2p_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
...
class toKtor$1 {
  constructor($this_toKtor) {
    this.y2p_1 = $this_toKtor;
  }
  s2p(buffer) {
    return this.y2p_1.decode(buffer);
  }
}
class TextDecoderFallback {
  constructor(encoding, fatal) {
    ...
    if (!get_ENCODING_ALIASES().r3(requestedEncoding)) {
  ...
  s2p(buffer) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        if (point > 255) {
          builder.t2j(toByte(point >> 8));
        }
        builder.t2j(toByte(point & 255));
      }
       while (inductionVariable < last);
...
function closeSlot($this, cause) {
  var closeContinuation = !(cause == null) ? new Closed(cause) : Companion_getInstance().g2l_1;
  var continuation = $this.w2l_1.atomicfu$getAndSet(closeContinuation);
  if (isInterface(continuation, Task)) {
    continuation.n2l(cause);
  }
  var tmp0_safe_receiver = $this.a2m_1.atomicfu$getAndSet(null);
  if (tmp0_safe_receiver == null)
    null;
  else
...
function ByteChannel$invokeOnClose$lambda_1(this$0, $handler) {
  return () => {
    this$0.a2m_1.atomicfu$compareAndSet($handler, null);
    return Unit_instance;
  };
}
function ByteReadChannel_0(content, offset, length) {
  ...
  this_0.j2j(content, offset, offset + length | 0);
  var source = this_0;
...
function buildPartialMatchTable($this) {
  var table = new Int32Array($this.k2n_1.m2());
  var j = 0;
  var inductionVariable = 1;
  var last = $this.k2n_1.m2();
  if (inductionVariable < last)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      while (j > 0 && !($this.k2n_1.k2(i) === $this.k2n_1.k2(j))) {
        j = table[j - 1 | 0];
      }
      if ($this.k2n_1.k2(i) === $this.k2n_1.k2(j)) {
        j = j + 1 | 0;
      }
      table[i] = j;
    }
...
function *advanceToNextPotentialMatch($this, $completion) {
  while (!$this.n2n_1.a2i() || (yield* $this.j2n_1.d2n(VOID, $completion))) {
    var nextMatch = indexOf($this.n2n_1, $this.k2n_1.k2(0));
    if (nextMatch === -1n) {
      var tmp = $this.n2n_1;
      checkBounds($this, (tmp instanceof Buffer ? tmp : THROW_CCE()).m2());
      $this.q2n_1 = add($this.q2n_1, $this.n2n_1.d2j($this.l2n_1.k2m()));
      yield* flushIfNeeded($this.l2n_1, $completion);
    } else {
      checkBounds($this, nextMatch);
      var tmp_0 = $this;
      var tmp_1 = $this.q2n_1;
      var tmp_2 = $this.l2n_1.k2m();
      tmp_0.q2n_1 = add(tmp_1, $this.n2n_1.a2j(tmp_2 instanceof Buffer ? tmp_2 : THROW_CCE(), nextMatch));
      yield* flushIfNeeded($this.l2n_1, $completion);
      return Unit_instance;
    }
  }
...
function *checkFullMatch($this, $completion) {
  while (!$this.n2n_1.a2i() || (yield* $this.j2n_1.d2n(VOID, $completion))) {
    var byte = $this.n2n_1.d2i();
    if ($this.r2n_1 > 0 && !(byte === $this.k2n_1.k2($this.r2n_1))) {
      var oldMatchIndex = $this.r2n_1;
      while ($this.r2n_1 > 0 && !(byte === $this.k2n_1.k2($this.r2n_1))) {
        $this.r2n_1 = $this.o2n_1[$this.r2n_1 - 1 | 0];
      }
      var retained = fromInt(oldMatchIndex - $this.r2n_1 | 0);
      checkBounds($this, retained);
      var tmp = $this;
      var tmp_0 = $this.q2n_1;
      var tmp_1 = $this.l2n_1.k2m();
      tmp.q2n_1 = add(tmp_0, $this.p2n_1.a2j(tmp_1 instanceof Buffer ? tmp_1 : THROW_CCE(), retained));
      if ($this.r2n_1 === 0 && !(byte === $this.k2n_1.k2($this.r2n_1))) {
        yield* writeByte($this.l2n_1, byte, $completion);
        var _unary__edvuaz = $this.q2n_1;
        $this.q2n_1 = add(_unary__edvuaz, get_ONE());
        return false;
      }
    }
    $this.r2n_1 = $this.r2n_1 + 1 | 0;
    if ($this.r2n_1 === $this.k2n_1.m2()) {
      return true;
    }
    $this.p2n_1.t2j(byte);
  }
...
function checkBounds($this, extra) {
  if (add($this.q2n_1, extra) > $this.m2n_1) {
    throw IOException.d2l('Limit of ' + $this.m2n_1.toString() + ' bytes exceeded ' + ('while searching for "' + toSingleLineString($this, $this.k2n_1) + '"'));
  }
}
...
function attachWriterJob(_this__u8e3s4, writerJob) {
  var tmp = writerJob.t2n_1;
  var tmp0_safe_receiver = tmp instanceof ByteChannel ? tmp : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.i2n(attachWriterJob$lambda(_this__u8e3s4));
  }
}
function attachWriterJob$lambda($this_attachWriterJob) {
  return (cause) => {
    var tmp;
    if (!(cause == null)) {
      $this_attachWriterJob.h2n(cause);
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function cancel_0(_this__u8e3s4) {
  _this__u8e3s4.h2n(IOException.d2l('Channel was cancelled'));
}
function *readRemaining(_this__u8e3s4, $completion) {
  var result = BytePacketBuilder();
  while (!_this__u8e3s4.w2m()) {
    result.s2j(_this__u8e3s4.e2m());
    yield* _this__u8e3s4.d2n(VOID, $completion);
  }
...
function *copyTo(_this__u8e3s4, channel, limit, $completion) {
  var remaining = limit;
  try {
    while (!_this__u8e3s4.w2m() && remaining > 0n) {
      if (_this__u8e3s4.e2m().a2i()) {
        yield* _this__u8e3s4.d2n(VOID, $completion);
      }
      var tmp0 = remaining;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = get_remaining(_this__u8e3s4.e2m());
      var count = tmp0 <= b ? tmp0 : b;
      _this__u8e3s4.e2m().c2j(channel.k2m(), count);
      remaining = subtract(remaining, count);
      yield* channel.e2n($completion);
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var cause = $p;
      _this__u8e3s4.h2n(cause);
...
function rethrowCloseCauseIfNeeded(_this__u8e3s4) {
  var tmp0_safe_receiver = _this__u8e3s4.r2m();
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
...
function *discard(_this__u8e3s4, max, $completion) {
  ...
  var remaining = max;
  while (remaining > 0n && !_this__u8e3s4.w2m()) {
    ...
    var b = get_remaining(_this__u8e3s4.e2m());
    var count = tmp0 <= b ? tmp0 : b;
    discard_0(_this__u8e3s4.e2m(), count);
    remaining = subtract(remaining, count);
  }
...
function *copyTo_0(_this__u8e3s4, channel, $completion) {
  ...
  try {
    while (!_this__u8e3s4.w2m()) {
      result = add(result, _this__u8e3s4.e2m().d2j(channel.k2m()));
      yield* channel.e2n($completion);
      yield* _this__u8e3s4.d2n(VOID, $completion);
    }
  } catch ($p) {
...
function *readAvailable(_this__u8e3s4, buffer, offset, length, $completion) {
  ...
  if (_this__u8e3s4.w2m())
    return -1;
  return readAvailable_0(_this__u8e3s4.e2m(), buffer, offset, length);
}
...
function *readPacket(_this__u8e3s4, packet, $completion) {
  ...
  $l$loop: while (result.m2() < fromInt(packet)) {
    ...
    if (_this__u8e3s4.w2m())
      break $l$loop;
    if (get_remaining(_this__u8e3s4.e2m()) > subtract(numberToLong(packet), result.m2())) {
      _this__u8e3s4.e2m().c2j(result, subtract(numberToLong(packet), result.m2()));
    } else {
      _this__u8e3s4.e2m().d2j(result);
    }
  }
  if (result.m2() < fromInt(packet)) {
    throw EOFException.y2h('Not enough data available, required ' + packet + ' bytes but only ' + result.m2().toString() + ' available');
  }
  return result;
}
function *readUntil(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion) {
  ...
  return yield* (new ByteChannelScanner(_this__u8e3s4, matchString, writeChannel, limit)).s2n(ignoreMissing, $completion);
}
...
function get_availableForRead(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.e2m().z2h().m2());
}
function *peek(_this__u8e3s4, count, $completion) {
  if (_this__u8e3s4.w2m())
    return null;
  if (!(yield* _this__u8e3s4.x2m(count, $completion)))
    return null;
  return readByteString(_this__u8e3s4.e2m().e2j(), count);
}
function *internalReadLineTo(_this__u8e3s4, out, limit, lenientLineEnding, throwOnIncompleteLine, $completion) {
  var readBuffer = _this__u8e3s4.e2m();
  if (readBuffer.a2i()) {
    yield* _this__u8e3s4.d2n(VOID, $completion);
  }
  if (_this__u8e3s4.w2m())
    return -1n;
  var consumed = {_v: 0n};
  $l$loop: while (consumed._v < limit && !_this__u8e3s4.w2m()) {
    ...
    if (lfIndex > 0n) {
      var tmp;
      var tmp_0 = readBuffer.z2h();
      // Inline function 'kotlin.Long.minus' call
      var tmp$ret$0 = subtract(lfIndex, fromInt(1));
      if (tmp_0.v2i(tmp$ret$0) === 13) {
        tmp = 1n;
      } else {
        tmp = 0n;
      }
    ...
    var tmp_1 = readBuffer.z2h();
    // Inline function 'kotlin.Long.minus' call
    var tmp$ret$2 = subtract(count, fromInt(1));
    if (tmp_1.v2i(tmp$ret$2) === 13) {
      // Inline function 'kotlin.Long.minus' call
    ...
    if (consumed._v < limit && get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.d2n(VOID, $completion)))
      break $l$loop;
  }
  if (consumed._v === 0n && _this__u8e3s4.w2m())
    return -1n;
  // Inline function 'kotlin.check' call
  ...
  if (consumed._v === limit) {
    if (limit === 9223372036854775807n)
      throw TooLongLineException.c2o('Max line length exceeded');
    if (get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.d2n(VOID, $completion))) {
      throwEndOfStreamException(consumed._v);
    }
    var tmp0_subject = readBuffer.z2h().v2i(0n);
    if (tmp0_subject === 10) {
      discard_0(readBuffer, 1n);
      return consumed._v;
...
function throwEndOfStreamException(consumed) {
  throw EOFException.y2h('Unexpected end of stream after reading ' + consumed.toString() + ' characters');
}
function throwTooLongLineException(limit) {
  throw TooLongLineException.c2o('Line exceeds limit of ' + limit.toString() + ' characters');
}
...
function *internalReadLineTo$discardCrlfOrCr(_this__u8e3s4, $this_internalReadLineTo, $lenientLineEnding, $completion) {
  if ((get_remaining(_this__u8e3s4) >= 2n || (yield* $this_internalReadLineTo.x2m(2, $completion))) && _this__u8e3s4.z2h().v2i(1n) === 10) {
...
function *flushIfNeeded(_this__u8e3s4, $completion) {
  ...
  if (_this__u8e3s4.c2m() || get_size(_this__u8e3s4.k2m()) >= 1048576)
    yield* _this__u8e3s4.e2n($completion);
  return Unit_instance;
}
function ByteWriteChannel$flushAndClose$ref(p0) {
  return constructCallableReference(function *($completion) {
    return yield* p0.g2n($completion);
...
function invokeOnCompletion(_this__u8e3s4, block) {
  _init_properties_ByteWriteChannelOperations_kt__i7slrs();
  return _this__u8e3s4.i12().hx(block);
}
function *writeFully(_this__u8e3s4, value, startIndex, endIndex, $completion) {
  startIndex = startIndex === VOID ? 0 : startIndex;
  endIndex = endIndex === VOID ? value.length : endIndex;
  _this__u8e3s4.k2m().j2j(value, startIndex, endIndex);
...
function *writePacket(_this__u8e3s4, source, $completion) {
  while (!source.a2i()) {
    _this__u8e3s4.k2m().n2j(source, get_remaining(source));
    yield* flushIfNeeded(_this__u8e3s4, $completion);
  }
  return Unit_instance;
}
function writer_0(_this__u8e3s4, coroutineContext, channel, block) {
  ...
  this_0.hx(writer$lambda(channel));
  var job = this_0;
...
function *writeByte(_this__u8e3s4, value, $completion) {
  _this__u8e3s4.k2m().t2j(value);
  yield* flushIfNeeded(_this__u8e3s4, $completion);
  return Unit_instance;
}
function writer$slambda($block, $channel) {
  return constructCallableReference(function *($this$launch, $completion) {
    var nested = Job(get_job($this$launch.fw()));
    var tmp;
    try {
      yield* $block(new WriterScope($channel, $this$launch.fw().qm(nested)), $completion);
      nested.u12();
      var tmp_0;
      if (get_job($this$launch.fw()).bx()) {
        $channel.h2n(get_job($this$launch.fw()).ex());
        tmp_0 = Unit_instance;
      }
      tmp = tmp_0;
    } catch ($p) {
      ...
      yield* nested.lx($completion);
      // Inline function 'kotlin.runCatching' call
      var tmp_2;
      try {
        yield* $channel.g2n($completion);
        // Inline function 'kotlin.Companion.success' call
...
function transferFromDelegate($this) {
  updateConsumed($this);
  var appended = $this.i2o_1.s2j($this.h2o_1.e2m());
  $this.j2o_1 = add($this.j2o_1, appended);
}
function updateConsumed($this) {
  $this.k2o_1 = add($this.k2o_1, subtract($this.j2o_1, $this.i2o_1.m2()));
  $this.j2o_1 = $this.i2o_1.m2();
}
...
function LineEndingMode__toString_impl_j4h76r($this) {
  var tmp;
  if ($this === Companion_getInstance_2().m2o_1) {
    tmp = 'CR';
  } else if ($this === Companion_getInstance_2().n2o_1) {
    tmp = 'LF';
  } else if ($this === Companion_getInstance_2().o2o_1) {
    tmp = 'CRLF';
  } else {
    // Inline function 'kotlin.collections.filter' call
    var tmp0 = Companion_getInstance_2().q2o_1;
    // Inline function 'kotlin.collections.filterTo' call
    var destination = ArrayList.l2();
    var _iterator__ex2g4s = tmp0.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var it = element.r2o_1;
...
function writeFully_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  _this__u8e3s4.j2j(buffer, offset, offset + length | 0);
}
function build(_this__u8e3s4) {
  return _this__u8e3s4.z2h();
}
function get_size(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.z2h().m2());
}
...
function ByteReadPacket(array, offset, length) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = new Buffer();
  this_0.j2j(array, offset, offset + length | 0);
  return this_0;
}
function get_remaining(_this__u8e3s4) {
  _init_properties_ByteReadPacket_kt__28475y();
  return _this__u8e3s4.z2h().m2();
}
function takeWhile(_this__u8e3s4, block) {
  _init_properties_ByteReadPacket_kt__28475y();
  while (!_this__u8e3s4.a2i() && block(_this__u8e3s4.z2h())) {
  }
}
function discard_0(_this__u8e3s4, count) {
  count = count === VOID ? 9223372036854775807n : count;
  _init_properties_ByteReadPacket_kt__28475y();
  _this__u8e3s4.c2i(count);
  // Inline function 'kotlin.comparisons.minOf' call
  var b = get_remaining(_this__u8e3s4);
  var countToDiscard = count <= b ? count : b;
  _this__u8e3s4.z2h().x2i(countToDiscard);
...
function readAvailable_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  var result = _this__u8e3s4.y2i(buffer, offset, offset + length | 0);
  return result === -1 ? 0 : result;
}
function toByteArray_0(_this__u8e3s4, charset) {
  charset = charset === VOID ? Charsets_getInstance().y2o_1 : charset;
  if (charset.equals(Charsets_getInstance().y2o_1))
    return encodeToByteArray(_this__u8e3s4, VOID, VOID, true);
  return encodeToByteArray_0(charset.b2p(), _this__u8e3s4, 0, _this__u8e3s4.length);
}
function readText_0(_this__u8e3s4, charset, max) {
  ...
  if (charset.equals(Charsets_getInstance().y2o_1)) {
    if (max === 2147483647)
      return readString_0(_this__u8e3s4);
    var tmp0 = _this__u8e3s4.z2h().m2();
    // Inline function 'kotlin.math.min' call
    var b = fromInt(max);
    var count = tmp0 <= b ? tmp0 : b;
    return readString(_this__u8e3s4, count);
  }
  return decode(charset.c2p(), _this__u8e3s4, max);
}
function writeText(_this__u8e3s4, text, fromIndex, toIndex, charset) {
  fromIndex = fromIndex === VOID ? 0 : fromIndex;
  toIndex = toIndex === VOID ? charSequenceLength(text) : toIndex;
  charset = charset === VOID ? Charsets_getInstance().y2o_1 : charset;
  if (charset === Charsets_getInstance().y2o_1) {
    return writeString(_this__u8e3s4, toString_1(text), fromIndex, toIndex);
  }
  encodeToImpl(charset.b2p(), _this__u8e3s4, text, fromIndex, toIndex);
}
...
function forName(_this__u8e3s4, name) {
  return Companion_instance_4.p2p(name);
}
function decode_0(_this__u8e3s4, input, dst, max) {
  var decoder = Decoder(get_name(get_charset(_this__u8e3s4)), true);
  var tmp0 = input.z2h().m2();
  // Inline function 'kotlin.comparisons.minOf' call
  var b = fromInt(max);
  var count = tmp0 <= b ? tmp0 : b;
  ...
  try {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    tmp = decoder.s2p(array);
  } catch ($p) {
    var tmp_0;
    if ($p instanceof Error) {
      var cause = $p;
      var tmp0_elvis_lhs = cause.message;
      throw MalformedInputException.x2o('Failed to decode bytes: ' + (tmp0_elvis_lhs == null ? 'no cause provided' : tmp0_elvis_lhs));
    } else {
      throw $p;
    }
  }
...
function encodeImpl(_this__u8e3s4, input, fromIndex, toIndex, dst) {
  ...
  if (get_charset_0(_this__u8e3s4).equals(Charsets_getInstance().z2o_1)) {
    return encodeISO88591(input, fromIndex, toIndex, dst);
  }
  // Inline function 'kotlin.require' call
  if (!(get_charset_0(_this__u8e3s4) === Charsets_getInstance().y2o_1)) {
...
function ioDispatcher() {
  return Dispatchers_getInstance().d17_1;
}
function encodeISO88591(input, fromIndex, toIndex, dst) {
  ...
  if (inductionVariable < toIndex)
    do {
      ...
      dst.t2j(toByte(character));
    }
     while (inductionVariable < toIndex);
  return toIndex - fromIndex | 0;
}
function failedToMapError(ch) {
  throw MalformedInputException.x2o('The character with unicode point ' + ch + " couldn't be mapped to ISO-8859-1 character");
}
...
protoOf(Read).m2l = resume;
protoOf(Read).n2l = resume_0;
initMetadataForClass(Read, 'Read', VOID, VOID, [Task]);
protoOf(Write).m2l = resume;
protoOf(Write).n2l = resume_0;
...
protoOf(ByteChannel).d2n = awaitContent$default;
...
protoOf(ByteReadChannel$Companion$Empty$1).d2n = awaitContent$default;
...
protoOf(CountedByteReadChannel).d2n = awaitContent$default;
initMetadataForClass(CountedByteReadChannel, 'CountedByteReadChannel', VOID, VOID, [ByteReadChannel], [1]);
initMetadataForClass(ClosedByteChannelException, 'ClosedByteChannelException', ClosedByteChannelException.v2m);
initMetadataForClass(ClosedReadChannelException, 'ClosedReadChannelException', ClosedReadChannelException.j2m);
initMetadataForClass(ClosedWriteChannelException, 'ClosedWriteChannelException', ClosedWriteChannelException.p2m);
initMetadataForClass(LineEnding, 'LineEnding');
initMetadataForCompanion(Companion_2);
initMetadataForClass(LineEndingMode, 'LineEndingMode');
protoOf(SourceByteReadChannel).d2n = awaitContent$default;
...
protoOf(DefaultPool).y5 = close;
initMetadataForClass(DefaultPool, 'DefaultPool', VOID, VOID, [ObjectPool]);
initMetadataForClass(ByteArrayPool$1);
protoOf(NoPoolImpl).y5 = close;
